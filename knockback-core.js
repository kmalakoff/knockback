...
*/
            ...
            module.exports = kb = function () {
                ...
                _createClass(kb, null, [
                  ...
                  },
                  {
                    ...
                    value: function isReleaseable(obj) {
                      ...
                      for (
                        j = 0, len = LIFECYCLE_METHODS.length;
                        j < len;
                        j++
                      ) {
              ...
              kb.ignore =
                ((ref = ko.dependencyDetection) != null
                  ? ref.ignore
                  : void 0) ||
              ...
              function CollectionObservable(collection, view_model, options) {
                ...
                return kb.ignore(function () {
                  ...
                  create_options.creator =
                    create_options.factory.creatorForPath(
                      null,
                      create_options.path
                    );
                    ...
                    if (!models || current_collection.models.length === 0) {
                      ...
                      if (comparator) {
                        ...
                        if (_this.models_only) {
                          view_models = filters.length
                            ? models
                            : models.slice(); // clone the array if it wasn't filtered
                        } else {
                          view_models = _.map(models, function (model) {
                            return _this._createViewModel(model);
                          });
                ...
                },
                {
                  ...
                  value: function _attributeComparator(sort_attribute) {
                    ...
                    modelAttributeCompare = function modelAttributeCompare(
                      ...
                      var attribute_name;
                      attribute_name =
                        ko.utils.unwrapObservable(sort_attribute);
                      return kb.compare(
                ...
                observable = kb.utils.wrappedObservable(
                  ...
                  ko.computed({
                    read: function read() {
                      ...
                      if (
                        (ref1 = kb.utils.wrappedEventWatcher(_this)) != null
                      ) {
                ...
                [
                  ...
                  },
                  {
                    ...
                    value: function reuse(observable, obj) {
                      ...
                      if (
                        (current_obj = kb.utils.wrappedObject(observable)) ===
                        obj
                      ) {
                        return;
                      }
...
*/
          ...
          kb.utils = function () {
              ...
              _createClass(utils, null, [
                ...
                },
                {
                  ...
                  value: function wrappedModel(obj, value) {
                    if (arguments.length === 1) {
                      if (
                        _.isUndefined((value = kb.utils.get(obj, "object")))
                      ) {
                        return obj;
                      } else {
                        return value;
            ...
            utils.wrappedDestroy = __webpack_require__(18); // Helper to merge options including ViewmModel options like `keys` and `factories`
            // @param [Object] obj the object to test
            // @example
            //   kb.utils.collapseOptions(options);

            utils.collapseOptions = __webpack_require__(15); // used for attribute setting to ensure all model attributes have their underlying models
...
*/
          ...
          createStaticObservables = function createStaticObservables(
            vm,
            model
          ) {
