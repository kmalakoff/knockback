...
(function () {
  ...
  _.reduceRight = _.foldr = function (obj, iterator, memo, context) {
    ...
    const reversed = (_.isArray(obj) ? obj.slice() : _.toArray(obj)).reverse();
  ...
  _.uniq = _.unique = function (array, isSorted) {
    return _.reduce(array, (memo, el, i) => {
      if (i == 0 || (isSorted === true ? _.last(memo) != el : !_.include(memo, el))) memo[memo.length] = el;
      return memo;
    }, []);
  };
  ...
  _.difference = function (array, other) {
    return _.filter(array, value => !_.include(other, value));
  };
  ...
  _.wrap = function (func, wrapper) {
    return function () {
      const args = [func].concat(slice.call(arguments));
  ...
  _.keys = nativeKeys || function (obj) {
    ...
    const keys = [];
    for (const key in obj) if (hasOwnProperty.call(obj, key)) keys[keys.length] = key;
    return keys;
  };
  ...
  _.isEqual = function (a, b) {
    ...
    for (const key in a) if (!(key in b) || !_.isEqual(a[key], b[key])) return false;
    return true;
  };
