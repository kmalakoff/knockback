...
if (root.Parse) {
  ...
  kb._ = __webpack_require__(13);_ = kb._;
}
kb.ko = ko;
...
(function(factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(13), __webpack_require__(22), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
