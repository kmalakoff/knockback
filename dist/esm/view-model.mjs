...
const Cls = kb.ViewModel = class ViewModel {
    ...
    constructor(model, options, _view_model){
        ...
        return kb.ignore(()=>{
            ...
            var event_watcher = kb.utils.wrappedEventWatcher(this, new kb.EventWatcher(model, this, {
                emitter: this._model,
                update: ()=>kb.ignore(()=>!(event_watcher != null ? event_watcher.ee : undefined) || this.createObservables(event_watcher != null ? event_watcher.ee : undefined))
            }));
