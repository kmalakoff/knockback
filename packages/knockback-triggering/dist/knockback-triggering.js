(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("knockback"), require("underscore"), require("knockout"));
	else if(typeof define === 'function' && define.amd)
		define(["knockback", "underscore", "knockout"], factory);
	else if(typeof exports === 'object')
		exports["kbt"] = factory(require("knockback"), require("underscore"), require("knockout"));
	else
...
var TriggeredObservable = function () {
  ...
  function TriggeredObservable(emitter, event_selector) {
    ...
    emitter || _knockback2.default._throwMissing(this, 'emitter');
    this.event_selector || _knockback2.default._throwMissing(this, 'event_selector');

    // internal state
    this.vo = _knockout2.default.observable();
    var observable = _knockback2.default.utils.wrappedObservable(this, _knockout2.default.computed(function () {
      return _this.vo();
    }));
    ...
    _knockback2.default.utils.wrappedEventWatcher(this, new _knockback2.default.EventWatcher(emitter, this, { emitter: _underscore2.default.bind(this.emitter, this), update: _underscore2.default.bind(this.update, this), event_selector: this.event_selector }));
