...
var _knockback = __webpack_require__(2);
...
var BackboneRelational = function () {
  ...
  _createClass(BackboneRelational, null, [{
    ...
    value: function relationType(model, key) {
      ...
      return relation.collectionType || _underscore2.default.isArray(relation.keyContents) ? _knockback2.default.TYPE_COLLECTION : _knockback2.default.TYPE_MODEL;
    }
  }, {
    key: 'customBind',
    value: function customBind(model, key, update, path) {
      ...
      var relFn = function relFn(m) {
        if (_knockback2.default.statistics) _knockback2.default.statistics.addModelEvent({ name: 'update (relational)', model: m, key: key, path: path });
        return update();
      };
      ...
      if (type === _knockback2.default.TYPE_COLLECTION) _underscore2.default.each(events, function (event) {
