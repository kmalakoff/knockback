      ...
      [
        ...
        function (e, t, r) {
          ...
          function o(o, e, i) {
            ...
            return (
              (s = Array.prototype.slice.call(
                _.isArguments(o) ? o : arguments
              )),
              p.ignore(function () {
                var e, t, l, r, n;
                for (
                  o =
                    s[0] instanceof p.Collection
                      ? s.shift()
                      : _.isArray(s[0])
                      ? new p.Collection(s.shift())
                      : new p.Collection(),
                    _.isFunction(s[0]) && (s[0] = { view_model: s[0] }),
                    i = {},
                    r = 0,
                    n = s.length;
                  r < n;
                  ...
                  (e = s[r]), _.extend(i, e);
                return (
                  ((l = p.utils.wrappedObservable(
                    u,
                    c.observableArray([])
                  )).__kb_is_co = !0),
                  (u.in_edit = 0),
                  u.__kb || (u.__kb = {}),
                  (i = p.utils.collapseOptions(i)).auto_compact &&
                    (u.auto_compact = !0),
                  i.sort_attribute
                  ...
                  i.filters
                    ...
                    : (u._filters = c.observableArray([])),
                  (t = u.create_options =
                    { store: p.Store.useOptionsOrCreate(i, o, l) }),
                  p.utils.wrappedObject(l, o),
                  (u.path = i.path),
                  (t.factory = p.utils.wrappedFactory(
                    l,
                    u._shareOrCreateFactory(i)
                  )),
                  (t.path = p.utils.pathJoin(i.path, "models")),
                  (t.creator = t.factory.creatorForPath(null, t.path)),
                  t.creator && (u.models_only = t.creator.models_only),
                  p.publishMethods(l, u, a),
                  ...
                  l.subscribe(_.bind(u._onObservableArrayChange, u)),
                  p.statistics &&
                    p.statistics.register("CollectionObservable", u),
                  l
                );
              })
            );
          ...
          (n = p = r(0)),
            ...
            (p.CollectionObservable =
              ((o.extend = p.extend),
              (o.prototype.destroy = function () {
                var e, t, r;
                return (
                  (this.__kb_released = !0),
                  (r = p.utils.wrappedObservable(this)),
                  (t = p.peek(this._collection)),
                  p.utils.wrappedObject(r, null),
                  t &&
                    (t.unbind("all", this._onCollectionChange),
                    (e = p.peek(r)).splice(0, e.length)),
                  this.collection.dispose(),
                  (this._collection = r.collection = this.collection = null),
                  this._mapper.dispose(),
                  (this._mapper = null),
                  p.release(this._filters),
                  (this._filters = null),
                  ...
                  !p.statistics ||
                    p.statistics.unregister("CollectionObservable", this)
                );
              }),
              (o.prototype.shareOptions = function () {
                ...
                return (
                  ...
                  {
                    store: p.utils.wrappedStore(e),
                    factory: p.utils.wrappedFactory(e),
                  }
                );
              }),
              ...
              (o.prototype.viewModelByModel = function (r) {
                ...
                return this.models_only
                  ...
                  : ((n = r.hasOwnProperty(r.idAttribute)
                      ...
                      : "cid"),
                    _.find(
                      p.peek(p.utils.wrappedObservable(this)),
                      function (e) {
                        var t;
                        return (
              ...
              (o.prototype.compact = function () {
                ...
                return p.ignore(function () {
                  var e;
                  if (
                    ((e = p.utils.wrappedObservable(t)),
                    p.utils.wrappedStoreIsOwned(e))
                  )
                    return (
                      p.utils.wrappedStore(e).clear(),
              ...
              (o.prototype._shareOrCreateFactory = function (e) {
                var t, r, n, o;
                if (
                  ((t = p.utils.pathJoin(e.path, "models")),
                  (n = e.factories),
                  (o = e.factory) &&
                  ...
                  if (!i.in_edit && !p.wasReleased(i))
                    switch (n) {
                      ...
                      case "change":
                        ...
                        i.in_edit++,
                          p.utils.wrappedObservable(i).sort(t),
                          i.in_edit--;
                    }
                });
              }),
              (o.prototype._onModelRemove = function (e) {
                ...
                if ((r = this.models_only ? e : this.viewModelByModel(e)))
                  return (
                    (t = p.utils.wrappedObservable(this)),
                    this.in_edit++,
                    t.remove(r),
                    this.in_edit--
                  );
              ...
              (o.prototype._onObservableArrayChange = function (c) {
                ...
                return p.ignore(function () {
                  ...
                  if (
                    !d.in_edit &&
                    ((d.models_only && (!c.length || p.isModel(c[0]))) ||
                      (!d.models_only &&
                        (!c.length ||
                          (_.isObject(c[0]) && !p.isModel(c[0])))) ||
                      p._throwUnexpected(d, "incorrect type passed"),
                    (i = p.utils.wrappedObservable(d)),
                    (e = p.peek(d._collection)),
                    (r = p.peek(d._filters).length),
                    e)
                  ) {
                    if (((a = c), d.models_only))
                      o = _.filter(c, function (e) {
                      ...
                      for (
                        ...
                        if (((s = c[l]), (n = p.utils.wrappedObject(s)), r)) {
                    ...
                    d.in_edit++,
                      ...
                      _.isEqual(e.models, o) || e.reset(o),
                      d.in_edit--;
                  }
                });
              }),
              (o.prototype._attributeComparator = function (n) {
                ...
                return (
                  ...
                  this.models_only
                    ...
                    : function (e, t) {
                        return r(
                          p.utils.wrappedModel(e),
                          p.utils.wrappedModel(t)
                        );
                      }
                );
              }),
              ...
              (o.prototype._selectModel = function (e) {
                var t, r, n, o, i;
                for (n = 0, o = (r = p.peek(this._filters)).length; n < o; n++)
                  if (((t = r[n]), (t = p.peek(t)), _.isFunction(t))) {
                    if (!t(e)) return !1;
                  } else if (_.isArray(t)) {
              ...
              o)),
            (p.collectionObservable = function (e, t, r) {
              return new p.CollectionObservable(arguments);
            }),
            (p.observableCollection = p.collectionObservable);
        },
        function (e, t, r) {
          function n(e, t) {
            return function () {
                    ...
                    l = [],
                      s = function (e) {
                        ...
                        for (
                          e.__kb_injected ||
                            (e.attributes &&
                              (t = _.find(e.attributes, function (e) {
          ...
          function o(s, a, l, e) {
            ...
            return (
              ...
              _.ignore(function () {
                var e, t, r, n, o, i;
                for (
                  a || _._throwMissing(u, "key_or_info"),
                    u.key = a.key || a,
                    o = 0,
                    i = c.length;
                  o < i;
                  ...
                  a[(r = c[o])] && (u[r] = a[r]);
                return (
                  (t = (e = _.utils.collapseOptions(l)).event_watcher),
                  delete e.event_watcher,
                  (u._value = new p(e)),
                  (u._model = f.observable()),
                  ((n = _.utils.wrappedObservable(
                    u,
                    f.computed({
                      read: function () {
                        var e, t, r, n, o, i, s;
                        ...
                        return (
                          null != (s = _.utils.wrappedEventWatcher(u)) &&
                            s.emitter(o || null),
                          u.read
                            ...
                            : b.isUndefined(o) ||
                              _.ignore(function () {
                                return u.update(
                                  _.getValue(o, _.peek(u.key), u.args)
                                );
                              }),
                          u._value.value()
                        );
                      ...
                      write: function (r) {
                        return _.ignore(function () {
                          var e, t;
                          return (
                            (e = _.utils.unwrapModels(r)),
                            (t = _.peek(u._model)),
                            u.write
                              ? (u.write.call(u._vm, e),
                                (r = _.getValue(t, _.peek(u.key), u.args)))
                              : t && _.setValue(t, _.peek(u.key), e),
                            u.update(r)
                          );
                        });
                      },
                  ...
                  (e.store = _.utils.wrappedStore(n, e.store)),
                  (e.path = _.utils.pathJoin(e.path, u.key)),
                  e.factories &&
                  ("function" == typeof e.factories || e.factories.create)
                    ? ((e.factory = _.utils.wrappedFactory(
                        n,
                        new _.Factory(e.factory)
                      )),
                      e.factory.addPathMapping(e.path, e.factories))
                    : (e.factory = _.Factory.useOptionsOrCreate(e, n, e.path)),
                  delete e.factories,
                  _.publishMethods(n, u, d),
                  (n.model = u.model =
                    f.computed({
                      read: function () {
                      ...
                      write: function (t) {
                        return _.ignore(function () {
                          var e;
                          if (!u.__kb_released && _.peek(u._model) !== t)
                            return (
                              (e = _.getValue(t, _.peek(u.key), u.args)),
                              u._model(t),
                              t
                                ? b.isUndefined(e)
                                  ? void 0
                  ...
                  _.EventWatcher.useOptionsOrCreate(
                    { event_watcher: t },
                    s || null,
                    u,
                    {
                  ...
                  _.LocalizedObservable &&
                    a.localizer &&
                    (n = new a.localizer(n)),
                  _.DefaultObservable &&
                    a.hasOwnProperty("default") &&
                    (n = _.defaultObservable(n, a.default)),
                  n
                );
              })
            );
            ...
            (_.Observable =
              ...
              (o.prototype.update = function (e) {
                if (!this.__kb_released)
                  return (
                    arguments.length ||
                      (e = _.getValue(_.peek(this._model), _.peek(this.key))),
                    this._value.update(e)
                  );
              }),
              o)),
            (_.observable = function (e, t, r, n) {
              return new _.Observable(e, t, r, n);
            });
        },
        function (e, t, r) {
          var n, u;
            ...
            return (
              ...
              b.ignore(function () {
                ...
                for (
                  !(l = c.shift()) ||
                    b.isModel(l) ||
                    b._throwUnexpected(d, "not a model"),
                  ...
                  (e = c[n]), v.extend(u, e);
                for (
                  u = b.utils.collapseOptions(u), o = 0, s = p.length;
                  o < s;
                  o++
                )
                  (r = p[o]), u.hasOwnProperty(r) && (d.__kb[r] = u[r]);
                return (
                  b.Store.useOptionsOrCreate(u, l, d),
                  (d.__kb.path = u.path),
                  b.Factory.useOptionsOrCreate(u, d, u.path),
                  (a = b.utils.set(d, "_model", h.observable())),
                  (d.model = h.computed({
                    read: function () {
                      return h.utils.unwrapObservable(a);
                    },
                    write: function (e) {
                      return b.ignore(function () {
                        if (!b.wasReleased(d) && t)
                          return (
                            d.__kb.store.reuse(d, b.utils.resolveModel(e)),
                            t.emitter(e),
                            a(t.ee),
                  ...
                  (t = b.utils.wrappedEventWatcher(
                    d,
                    new b.EventWatcher(l, d, {
                      emitter: d._model,
                      update: function () {
                        return b.ignore(function () {
                          return (
                  ...
                  b.utils.wrappedObject(d, (l = t.ee)),
                  a(t.ee),
                  (d.__kb.create_options = {
                    store: b.utils.wrappedStore(d),
                    factory: b.utils.wrappedFactory(d),
                    path: d.__kb.path,
                    event_watcher: b.utils.wrappedEventWatcher(d),
                  }),
                  ...
                  b.statistics && b.statistics.register("ViewModel", d),
                  d
                );
              })
            );
          ...
          (n = b = r(0)),
            ...
            (_ = function (e, t, r, n) {
              ...
              if (
                ...
                return (e[o] = e.__kb.view_model[o] = b.observable(t, r, n, e));
            }),
            (f = function (e, t) {
              var r, n, o, i, s;
            ...
            (b.ViewModel =
              ...
              (o.prototype.destroy = function () {
                ...
                return (
                  ...
                  b.releaseKeys(this),
                  b.utils.wrappedDestroy(this),
                  !b.statistics || b.statistics.unregister("ViewModel", this)
                );
              }),
              (o.prototype.shareOptions = function () {
                return {
                  store: b.utils.wrappedStore(this),
                  factory: b.utils.wrappedFactory(this),
                };
              }),
                ...
                if (t)
                  if (v.isArray(t))
                    for (a = 0, u = t.length; a < u; a++)
                      (r = t[a]), _(this, e, r, this.__kb.create_options);
                  else
                    for (r in t)
                      (n = t[r]),
                        (i = d(this, r)) &&
                  ...
                  for (r in e.attributes)
                    _(this, e, r, this.__kb.create_options);
                  if (
                    (o =
                      null != (c = b.settings.orm) &&
                      "function" == typeof c.keys
                        ? c.keys(e)
                        : void 0)
                  )
                    for (s = 0, l = o.length; s < l; s++)
                      (r = o[s]), _(this, e, r, this.__kb.create_options);
                }
              }),
              o)),
            (b.viewModel = function (e, t, r) {
              return new b.ViewModel(arguments);
            });
        },
        function (e, t, r) {
          var o, i, s, a, n;
          function l(t, e) {
            ...
            return (
              (this.dv = e),
              (r = i.utils.wrappedObservable(
                this,
                s.computed({
                  read: function () {
                    var e;
                    return (
                      (e = s.utils.unwrapObservable(t())),
                      a.isNull(e) || a.isUndefined(e)
                        ? s.utils.unwrapObservable(n.dv)
                        : e
                    );
                  },
                  write: function (e) {
          ...
          (n = i = r(0)),
            ...
            (e.exports = i.DefaultObservable =
              ((l.prototype.destroy = function () {
                return i.utils.wrappedDestroy(this);
              }),
              (l.prototype.setToDefault = function () {
                return i.utils.wrappedObservable(this)(this.dv);
              }),
              l)),
            (i.defaultObservable = function (e, t) {
              return new i.DefaultObservable(e, t);
            }),
            (i.observableDefault = i.defaultObservable);
        },
        function (e, t, r) {
          var a, s, l, f, n;
          function o(o, n) {
            var i;
            return (
              (i = f.isArray(n) ? ((o = o), n) : a.call(arguments, 1)),
              s.utils.wrappedObservable(
                this,
                l.computed({
                  read: function () {
                    var e, t, r;
                    for (
                      n = [l.utils.unwrapObservable(o)], t = 0, r = i.length;
                      t < r;
                      t++
                    )
                      (e = i[t]), n.push(l.utils.unwrapObservable(e));
                    return s.toFormattedString.apply(null, n);
                  },
                  write: function (e) {
                    var t, r, n;
                    for (
                      r = s.parseFormattedString(
                        e,
                        l.utils.unwrapObservable(o)
                      ),
          ...
          (n = s = r(0)),
            ...
            (s.toFormattedString = function (e) {
              var t, r, n, o, i, s;
              for (n in ((i = e.slice()), (r = a.call(arguments, 1))))
                for (
                  t = r[n],
                    s = l.utils.unwrapObservable(t),
                    (f.isUndefined(s) || f.isNull(s)) && (s = ""),
                    o = e.indexOf("{" + n + "}");
                  0 <= o;
            ...
            (s.parseFormattedString = function (e, t) {
              var r, n, o, i, s, a, l, u, c, d, p, _;
              for (
                c = t.slice(), a = o = 0, u = {};
                0 <= c.search("\\{" + o + "\\}");

              ) {
                for (l = t.indexOf("{" + o + "}"); 0 <= l; )
                  (c = c.replace("{" + o + "}", "(.*)")),
                    (u[l] = o),
                    a++,
                    (l = t.indexOf("{" + o + "}", l + 1));
              ...
              for (i in ((n = {}),
              (_ = f.sortBy(f.keys(u), function (e, t) {
                return parseInt(e, 10);
              }))))
                (o = u[(l = _[i])]), n.hasOwnProperty(o) || (n[o] = i);
              for (p = [], o = 0; o < r; ) p.push(s[n[o]]), o++;
              return p;
            }),
            (e.exports = s.FormattedObservable =
              ((o.prototype.destroy = function () {
                return s.utils.wrappedDestroy(this);
              }),
              o)),
            (s.formattedObservable = function (e, t) {
              return new s.FormattedObservable(e, a.call(arguments, 1));
            }),
            (s.observableFormatted = s.formattedObservable);
        },
        function (e, t, r) {
          var i, s, a, l, n;
          function o(e, t, r) {
            ...
            return (
              ...
              t || (t = {}),
              this.vm || (this.vm = {}),
              this.read || s._throwMissing(this, "read"),
              s.locale_manager || s._throwMissing(this, "kb.locale_manager"),
              this.__kb || (this.__kb = {}),
              (this.__kb._onLocaleChange = l.bind(this._onLocaleChange, this)),
              (this.__kb._onChange = t.onChange),
              this.value && (e = a.utils.unwrapObservable(this.value)),
              (this.vo = a.observable(e ? this.read(e, null) : null)),
              (n = s.utils.wrappedObservable(
                this,
                a.computed({
                  read: function () {
                    return (
                      o.value && a.utils.unwrapObservable(o.value),
                      o.vo(),
                      o.read(a.utils.unwrapObservable(o.value))
                    );
                  },
                  write: function (e) {
                    if (
                      (o.write || s._throwUnexpected(o, "writing to read-only"),
                      o.write(e, a.utils.unwrapObservable(o.value)),
                      o.vo(e),
                      o.__kb._onChange)
                    )
                      return o.__kb._onChange(e);
                  },
                  owner: this.vm,
                })
              )),
              s.publishMethods(n, this, i),
              s.locale_manager.bind("change", this.__kb._onLocaleChange),
              t.hasOwnProperty("default") &&
                (n = s.DefaultObservable && a.defaultObservable(n, t.default)),
              n
            );
          }
          (n = s = r(0)),
            (l = n._),
            (a = n.ko),
            (i = ["destroy", "observedValue", "resetToCurrent"]),
            s.locale_manager || (s.locale_manager = void 0),
            (e.exports = s.LocalizedObservable =
              ((o.extend = s.extend),
              (o.prototype.destroy = function () {
                return (
                  s.locale_manager.unbind("change", this.__kb._onLocaleChange),
                  (this.vm = null),
                  s.utils.wrappedDestroy(this)
                );
              }),
              (o.prototype.resetToCurrent = function () {
                var e, t;
                if (
                  ((t = s.utils.wrappedObservable(this)),
                  (e = this.value
                    ? this.read(a.utils.unwrapObservable(this.value))
                    : null),
                  t() !== e)
                )
                  return t(e);
              }),
              (o.prototype.observedValue = function (e) {
                if (0 === arguments.length) return this.value;
                (this.value = e), this._onLocaleChange();
              }),
              (o.prototype._onLocaleChange = function () {
                var e;
                if (
                  ((e = this.read(a.utils.unwrapObservable(this.value))),
                  this.vo(e),
                  this.__kb._onChange)
                )
              ...
              o)),
            (s.localizedObservable = function (e, t, r) {
              return new s.LocalizedObservable(e, t, r);
            }),
            (s.observableLocalized = s.localizedObservable);
        },
        function (e, t, r) {
          var o, i, s, a, n;
          function l(e, t) {
            ...
            return (
              ...
              e || i._throwMissing(this, "emitter"),
              this.event_selector || i._throwMissing(this, "event_selector"),
              (this.vo = s.observable()),
              (r = i.utils.wrappedObservable(
                this,
                s.computed(function () {
                  return n.vo();
              ...
              i.publishMethods(r, this, o),
              i.utils.wrappedEventWatcher(
                this,
                new i.EventWatcher(e, this, {
          ...
          (n = i = r(0)),
            ...
            (s = n.ko),
            (o = ["destroy"]),
            (e.exports = i.TriggeredObservable =
              ((l.prototype.destroy = function () {
                return i.utils.wrappedDestroy(this);
              }),
              (l.prototype.emitter = function (e) {
                return 0 === arguments.length || this.ee === e
                  ? this.ee
                  : (this.ee = e)
                  ? this.update()
              ...
              l)),
            (i.triggeredObservable = function (e, t) {
              return new i.TriggeredObservable(e, t);
            }),
            (i.observableTriggered = i.triggeredObservable);
        },
        function (e, t, r) {
          var d, _, f, b, n;
          (n = _ = r(0)),
            ...
            r(27),
            (d = function (e) {
              return "function" == typeof (e = f.utils.unwrapObservable(e))
                ? e.apply(null, Array.prototype.slice.call(arguments, 1))
                : e;
            }),
            (e.exports = _.Validation = function () {}),
            (_.valueValidator = function (l, u, c) {
              return (
                null == c && (c = {}),
                (c && "function" != typeof c) || (c = {}),
                f.computed(function () {
                  var e, t, r, n, o, i, s, a;
                  for (n in ((s = { $error_count: 0 }),
                  (t = f.utils.unwrapObservable(l)),
                  "disable" in c && (r = d(c.disable)),
                  "enable" in c && (r = !d(c.enable)),
                  (i = c.priorities || []),
                  b.isArray(i) || (i = [i]),
                  (e = i.length + 1),
                  u))
                    (a = u[n]),
                      ...
                      s[n] &&
                        (s.$error_count++,
                        (o = 0 <= b.indexOf(i, n)) || (o = i.length),
                        s.$active_error && o < e
                          ? ((s.$active_error = n), (e = o))
                          : s.$active_error ||
                            ((s.$active_error = n), (e = o)));
                  return (
                    (s.$enabled = !r),
                    (s.$disable = !!r),
                    (s.$valid = 0 === s.$error_count),
                    s
                  );
                })
              );
            }),
            (_.inputValidator = function (e, t, r) {
              var n, o, i, s, a, l, u, c, d;
              if (
                (null == r && (r = {}),
                (r && "function" != typeof r) || (r = {}),
                (c = _.valid),
                (i = t.getAttribute("name")) && !b.isString(i) && (i = null),
              ...
              if (
                ...
                return null;
              if (
                (s.validation_options &&
                  (b.defaults(s.validation_options, r),
                  (r = s.validation_options)),
                (n = {}),
                c[(l = t.getAttribute("type"))] && (n[l] = c[l]),
                t.hasAttribute("required") && (n.required = c.required),
                s.validations)
              )
                for (o in (d = s.validations)) (u = d[o]), (n[o] = u);
              return (
                (a = _.valueValidator(s.value, n, r)),
                (!i && !r.no_attach) || (e["$" + i] = a),
                a
              );
            }),
            (_.formValidator = function (e, t) {
              var r, n, o, i, s, a, l, u, c, d, p;
              for (
                s = {},
                  u = [],
                  (n = t.getAttribute("name")) && !b.isString(n) && (n = null),
                  ...
                  a.no_attach = !!n,
                  c = 0,
                  d = (p = t.getElementsByTagName("input")).length;
                c < d;
                c++
              )
                (i = (o = p[c]).getAttribute("name")) &&
                  (l = _.inputValidator(e, o, a)) &&
                  u.push((s[i] = l));
              return (
                (s.$error_count = f.computed(function () {
                  var e, t, r;
                  for (t = e = 0, r = u.length; t < r; t++)
                    e += (l = u[t])().$error_count;
                  return e;
                })),
                (s.$valid = f.computed(function () {
                  return 0 === s.$error_count();
                })),
                (s.$enabled = f.computed(function () {
                  var e, t, r;
                  for (e = !0, t = 0, r = u.length; t < r; t++)
                    e &= (l = u[t])().$enabled;
                  return e;
                })),
                (s.$disabled = f.computed(function () {
                  return !s.$enabled();
                })),
                n && (e["$" + n] = s),
                s
        ...
        function (e, t, r) {
          ...
          (s = n = r(0)),
            (i = s._),
            (o = s.ko),
            (n.Observable.prototype.setToDefault = function () {
              var e;
              null != (e = this.__kb_value) &&
                "function" == typeof e.setToDefault &&
                e.setToDefault();
            }),
            (n.ViewModel.prototype.setToDefault = function () {
              var e, t;
            ...
            (n.utils.setToDefault = function (e) {
              var t, r;
              if (e) {
                if (o.isObservable(e))
        ...
        function (e, t, r) {
          ...
          (u = s = r(0)),
            ...
            (n = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/),
            (o = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/),
            (s.valid = {
              required: function (e) {
                return !e;
            ...
            (s.hasChangedFn = function (t) {
              var r, n;
              return (
                (r = n = null),
                function () {
                  var e;
                  return n !== (e = a.utils.unwrapObservable(t))
                    ? ((r = (n = e) ? n.toJSON() : null), !1)
                    : !(!n || !r) && !l.isEqual(n.toJSON(), r);
                }
              );
            }),
            (s.minLengthFn = function (t) {
              return function (e) {
                return !e || e.length < t;
              };
            }),
            (s.uniqueValueFn = function (o, i, s) {
              return function (t) {
                var e, r, n;
                return (
                  (n = a.utils.unwrapObservable(o)),
                  (r = a.utils.unwrapObservable(i)),
                  (e = a.utils.unwrapObservable(s)),
                  !!(n && r && e) &&
                    !!l.find(e.models, function (e) {
                      return e !== n && e.get(r) === t;
                    })
                );
              };
            }),
            (s.untilTrueFn = function (n, o, e) {
              var i;
              return (
                (i = !1),
                e &&
                ...
                function (e) {
                  var t, r;
                  return (t = a.utils.unwrapObservable(o)) &&
                    (i |= !!(r = t(a.utils.unwrapObservable(e))))
                    ? r
                    : a.utils.unwrapObservable(n);
                }
              );
            }),
            (s.untilFalseFn = function (n, o, e) {
              var i;
              return (
                (i = !1),
                e &&
