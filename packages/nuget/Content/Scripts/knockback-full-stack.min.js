...
/*
  ...
  License: MIT (http://www.opensource.org/licenses/mit-license.php)
  Dependencies: Knockout.js, Backbone.js, and Underscore.js.
*/(function(){return function(e){return typeof define=="function"&&define.amd?define("knockback",["underscore","backbone","knockout"],e):e.call(this)}(function(){var e,t,n,r,i,s,o,u,a,f,l,c,h,p,d,v,m,g,y,b,w,E,S,x,T,N,C,k=function(e,t){return function(){return e.apply(t,arguments)}};g=function(){function t(){}return t.VERSION="0.16.7",t.TYPE_UNKNOWN=0,t.TYPE_SIMPLE=1,t.TYPE_ARRAY=2,t.TYPE_MODEL=3,t.TYPE_COLLECTION=4,t.release=function(n,r){var i,s,u,a,f,l,c,h;if(!n||n!==Object(n)||typeof n=="function"&&!y.isObservable(n)||n.__kb_destroyed||n instanceof e.Model||n instanceof e.Collection)return this;if(x.isArray(n)){i=n.splice(0,n.length);for(f=0,c=i.length;f<c;f++)s=i[f],t.release(s);return this}n.__kb_destroyed=!0,!r||r();if(y.isObservable(n)||typeof n.dispose=="function"||typeof n.destroy=="function"||typeof n.release=="function")if(y.isObservable(n)&&x.isArray(i=n())){if(n.__kb_is_co||n.__kb_is_o&&n.valueType()===o)n.destroy?n.destroy():n.dispose&&n.dispose();else if(i.length){a=i.slice(0),i.splice(0,i.length);for(l=0,h=a.length;l<h;l++)u=a[l],t.release(u)}}else n.release?n.release():n.destroy?n.destroy():n.dispose&&n.dispose();else this.releaseKeys(n);return this},t.releaseKeys=function(e){var n,r;for(n in e)r=e[n],n==="__kb"||t.release(r,function(){return e[n]=null});return this},t.releaseOnNodeRemove=function(e,n){return e||S(this,"missing view model"),n||S(this,"missing node"),y.utils.domNodeDisposal.addDisposeCallback(n,function(){return t.release(e)})},t.renderTemplate=function(e,n,r){var i,s;return r==null&&(r={}),i=document.createElement("div"),s=y.renderTemplate(e,n,r,i,"replaceChildren"),i.children.length===1&&(i=i.children[0]),t.releaseOnNodeRemove(n,i),s.dispose(),i},t.renderAutoReleasedTemplate=function(e,t,n){return n==null&&(n={}),b("kb.renderAutoReleasedTemplate","0.16.3","Please use kb.renderTemplate instead"),this.renderTemplate(e,t,n={})},t.applyBindings=function(e,n){return y.applyBindings(e,n),t.releaseOnNodeRemove(e,n)},t}(),this.Knockback=this.kb=g,typeof exports!="undefined"&&(module.exports=g);if(!this._&&typeof require!="undefined")try{x=require("lodash")}catch(L){x=require("underscore")}else x=this._;return g._=x=x.hasOwnProperty("_")?x._:x,g.Backbone=e=!this.Backbone&&typeof require!="undefined"?require("backbone"):this.Backbone,g.ko=y=!this.ko&&typeof require!="undefined"?require("knockout"):this.ko,E=function(e,t){throw""+(x.isString(e)?e:e.constructor.name)+": "+t+" is missing"},S=function(e,t){throw""+(x.isString(e)?e:e.constructor.name)+": "+t+" is unexpected"},b=function(e,t,n){var r;return this._legacy_warnings||(this._legacy_warnings={}),(r=this._legacy_warnings)[e]||(r[e]=0),this._legacy_warnings[e]++,console.warn("warning: '"+e+"' has been deprecated (will be removed in Knockback after "+t+"). "+n+".")},d=Array.prototype.splice,m=function(e){var t;t=x.clone(e);while(e.options)x.defaults(t,e.options),e=e.options;return delete t.options,t},f=g.TYPE_UNKNOWN,a=g.TYPE_SIMPLE,s=g.TYPE_ARRAY,u=g.TYPE_MODEL,o=g.TYPE_COLLECTION,C=function(e,t,n){return arguments.length===2?e&&e.__kb&&e.__kb.hasOwnProperty(t)?e.__kb[t]:void 0:(e||S(this,"no obj for wrapping "+t),e.__kb||(e.__kb={}),e.__kb[t]=n,n)},T=function(e,t){return d.call(e,1,0,t),e},N=function(e){var t,n,r;if(!e)return e;if(e.__kb)return"object"in e.__kb?e.__kb.object:e;if(x.isArray(e))return x.map(e,function(e){return N(e)});if(x.isObject(e)&&e.constructor==={}.constructor){n={};for(t in e)r=e[t],n[t]=N(r);return n}return e},g.utils=function(){function t(){}return t.wrappedObservable=function(e,t){return C.apply(this,T(arguments,"observable"))},t.wrappedObject=function(e,t){return C.apply(this,T(arguments,"object"))},t.wrappedModel=function(e,t){return arguments.length===1?(t=C(e,"object"),x.isUndefined(t)?e:t):C(e,"object",t)},t.wrappedStore=function(e,t){return C.apply(this,T(arguments,"store"))},t.wrappedStoreIsOwned=function(e,t){return C.apply(this,T(arguments,"store_is_owned"))},t.wrappedFactory=function(e,t){return C.apply(this,T(arguments,"factory"))},t.wrappedEventWatcher=function(e,t){return C.apply(this,T(arguments,"event_watcher"))},t.wrappedEventWatcherIsOwned=function(e,t){return C.apply(this,T(arguments,"event_watcher_is_owned"))},t.wrappedDestroy=function(e){var t;if(!e.__kb)return;return e.__kb.event_watcher&&e.__kb.event_watcher.releaseCallbacks(e),t=e.__kb,e.__kb=null,t.observable&&(t.observable.destroy=t.observable.release=null,this.wrappedDestroy(t.observable),t.observable=null),t.factory=null,t.event_watcher_is_owned&&t.event_watcher.destroy(),t.event_watcher=null,t.store_is_owned&&t.store.destroy(),t.store=null},t.valueType=function(t){return t?t.__kb_is_o?t.valueType():t.__kb_is_co||t instanceof e.Collection?o:t instanceof g.ViewModel||t instanceof e.Model?u:x.isArray(t)?s:a:f},t.pathJoin=function(e,t){return(e?e[e.length-1]!=="."?""+e+".":e:"")+t},t.optionsPathJoin=function(e,t){return x.defaults({path:this.pathJoin(e.path,t)},e)},t.inferCreator=function(t,n,r,i,s){var o,u;n&&(o=n.creatorForPath(t,r));if(o)return o;if(i&&e.RelationalModel&&i instanceof e.RelationalModel){s=y.utils.unwrapObservable(s),u=x.find(i.getRelations(),function(e){return e.key===s});if(u)return u.collectionType||x.isArray(u.keyContents)?g.CollectionObservable:g.ViewModel}return t?t instanceof e.Model?g.ViewModel:t instanceof e.Collection?g.CollectionObservable:null:null},t.createFromDefaultCreator=function(t,n){return t instanceof e.Model?g.viewModel(t,n):t instanceof e.Collection?g.collectionObservable(t,n):x.isArray(t)?y.observableArray(t):y.observable(t)},t.hasModelSignature=function(e){return e&&e.attributes&&!e.models&&typeof e.get=="function"&&typeof e.trigger=="function"},t.hasCollectionSignature=function(e){return e&&e.models&&typeof e.get=="function"&&typeof e.trigger=="function"},t.release=function(e){return b("kb.utils.release","0.16.0","Please use kb.release instead"),g.release(e)},t}(),g.Factory=function(){function e(e){this.parent_factory=e,this.paths={}}return e.useOptionsOrCreate=function(e,t,n){var r;return e.factory&&(!e.factories||e.factories&&e.factory.hasPathMappings(e.factories,n))?g.utils.wrappedFactory(t,e.factory):(r=g.utils.wrappedFactory(t,new g.Factory(e.factory)),e.factories&&r.addPathMappings(e.factories,n),r)},e.prototype.hasPath=function(e){return this.paths.hasOwnProperty(e)||this.parent_factory&&this.parent_factory.hasPath(e)},e.prototype.addPathMapping=function(e,t){return this.paths[e]=t},e.prototype.addPathMappings=function(e,t){var n,r;for(r in e)n=e[r],this.paths[g.utils.pathJoin(t,r)]=n},e.prototype.hasPathMappings=function(e,t){var n,r,i,s;n=!0;for(s in e)r=e[s],n&=(i=this.creatorForPath(null,g.utils.pathJoin(t,s)))&&r===i;return n},e.prototype.creatorForPath=function(e,t){var n;if(n=this.paths[t])return n.view_model?n.view_model:n;if(this.parent_factory)if(n=this.parent_factory.creatorForPath(e,t))return n;return null},e}(),g.Store=function(){function t(){this.observable_records=[],this.replaced_observables=[]}return t.useOptionsOrCreate=function(e,t,n){return e.store?(e.store.register(t,n,e),g.utils.wrappedStore(n,e.store)):(g.utils.wrappedStoreIsOwned(n,!0),g.utils.wrappedStore(n,new g.Store))},t.prototype.destroy=function(){return this.clear()},t.prototype.clear=function(){var e,t,n,r,i,s,o,u;o=this.observable_records;for(n=0,i=o.length;n<i;n++)t=o[n],g.release(t.observable);u=this.replaced_observables;for(r=0,s=u.length;r<s;r++)e=u[r],g.release(e);return this.observable_records=[],this.replaced_observables=[]},t.prototype.register=function(e,t,n){var r;if(!t)return;if(y.isObservable(t)||t.__kb_is_co)return;return g.utils.wrappedObject(t,e),e||(t.__kb_null=!0),r=n.creator?n.creator:n.path&&n.factory?n.factory.creatorForPath(e,n.path):null,r||(r=t.constructor),this.observable_records.push({obj:e,observable:t,creator:r}),t},t.prototype.findIndex=function(t,n){var r,i,s;if(!t||t instanceof e.Model){s=this.observable_records;for(r in s){i=s[r];if(!i.observable)continue;if(i.observable.__kb_destroyed){i.obj=null,i.observable=null;continue}if(!t&&!i.observable.__kb_null||t&&(i.observable.__kb_null||i.obj!==t))continue;if(i.creator===n||i.creator.create&&i.creator.create===n.create)return r}}return-1},t.prototype.find=function(e,t){var n;return(n=this.findIndex(e,t))<0?null:this.observable_records[n].observable},t.prototype.isRegistered=function(e){var t,n,r,i;i=this.observable_records;for(n=0,r=i.length;n<r;n++){t=i[n];if(t.observable===e)return!0}return!1},t.prototype.findOrCreate=function(t,n){var r,i;return n.store=this,n.creator||(n.creator=g.utils.inferCreator(t,n.factory,n.path)),!n.creator&&t instanceof e.Model&&(n.creator=kv.ViewModel),r=n.creator,r?r.models_only?t:(r&&(i=this.find(t,r)),i?i:(r.create?i=r.create(t,n):i=new r(t,n),i||(i=y.observable(null)),y.isObservable(i)||this.isRegistered(i)||this.register(t,i,n),i)):g.utils.createFromDefaultCreator(t,n)},t.prototype.findOrReplace=function(e,t,n){var r,i;return e||raiseUnexpected("obj missing"),(r=this.findIndex(e,t))<0?this.register(e,n,{creator:t}):(i=this.observable_records[r],g.utils.wrappedObject(i.observable)===e||S(this,"different object"),i.observable!==n&&(i.observable.constructor===n.constructor||S(this,"replacing different type"),this.replaced_observables.push(i.observable),i.observable=n),n)},t}(),h=function(e,t,n){return!g.statistics||g.statistics.addModelEvent({name:t,emitter:e,key:n.key,path:n.path})},g.EventWatcher=function(){function t(e,t,n){this._onModelUnloaded=k(this._onModelUnloaded,this),this._onModelLoaded=k(this._onModelLoaded,this),this.__kb||(this.__kb={}),this.__kb.callbacks={},this.__kb._onModelLoaded=x.bind(this._onModelLoaded,this),this.__kb._onModelUnloaded=x.bind(this._onModelUnloaded,this),n&&this.registerCallbacks(t,n),e?this.emitter(e):this.ee=null}return t.useOptionsOrCreate=function(e,t,n,r){return e.event_watcher?(e.event_watcher.emitter()!==t&&e.event_watcher.model_ref!==t&&S(this,"emitter not matching"),g.utils.wrappedEventWatcher(n,e.event_watcher).registerCallbacks(n,r)):(g.utils.wrappedEventWatcherIsOwned(n,!0),g.utils.wrappedEventWatcher(n,new g.EventWatcher(t)).registerCallbacks(n,r))},t.prototype.destroy=function(){return this.emitter(null),this.__kb.callbacks=null,g.utils.wrappedDestroy(this)},t.prototype.emitter=function(t){var n,r,i,s,o,u,a,f;if(arguments.length===0||this.ee===t)return this.ee;this.model_ref&&(this.model_ref.unbind("loaded",this.__kb._onModelLoaded),this.model_ref.unbind("unloaded",this.__kb._onModelUnloaded),this.model_ref.release(),this.model_ref=null),e.ModelRef&&t instanceof e.ModelRef?(this.model_ref=t,this.model_ref.retain(),this.model_ref.bind("loaded",this.__kb._onModelLoaded),this.model_ref.bind("unloaded",this.__kb._onModelUnloaded),t=this.model_ref.model()):delete this.model_ref,o=this.ee,this.ee=t,f=this.__kb.callbacks;for(r in f){n=f[r],o&&o.unbind(r,n.fn),t&&this.ee.bind(r,n.fn),s=n.list;for(u=0,a=s.length;u<a;u++)i=s[u],i.emitter&&i.emitter(this.ee)}return t},t.prototype.registerCallbacks=function(t,n){var r,i,s,o,u,a,f,l,c=this;t||E(this,"obj"),n||E(this,"info"),o=n.event_selector?n.event_selector:"change",s=o.split(" ");for(f=0,l=s.length;f<l;f++){i=s[f];if(!i)continue;r=this.__kb.callbacks[i],r||(a=[],r={list:a,fn:function(e){var t,n,r;for(n=0,r=a.length;n<r;n++){t=a[n];if(t.update&&!t.rel_fn){if(e&&t.key&&e.hasChanged&&!e.hasChanged(y.utils.unwrapObservable(t.key)))continue;!g.statistics||h(e,i,t),t.update()}}return null}},this.__kb.callbacks[i]=r,this.ee&&this.ee.bind(i,r.fn)),u=x.defaults({obj:t},n),r.list.push(u)}this.ee&&(e.RelationalModel&&this.ee instanceof e.RelationalModel&&x.contains(s,"change")&&this._modelBindRelatationalInfo("change",u),u.emitter(this.ee)&&u.emitter)},t.prototype.releaseCallbacks=function(e){var t,n,r,i,s,o;if(!this.__kb.callbacks)return;s=this.__kb.callbacks;for(n in s){t=s[n],o=t.list;for(r in o){i=o[r];if(i.obj!==e)continue;t.list.splice(r,1),i.rel_fn&&this._modelUnbindRelatationalInfo(n,i),i.emitter&&i.emitter(null);return}}},t.prototype._onModelLoaded=function(t){var n,r,i,s,o,u,a,f;s=e.RelationalModel&&t instanceof e.RelationalModel,this.ee=t,f=this.__kb.callbacks;for(r in f){n=f[r],this.ee.bind(r,n.fn),o=n.list;for(u=0,a=o.length;u<a;u++)i=o[u],s&&this._modelBindRelatationalInfo(r,i),i.emitter&&i.emitter(this.ee)}},t.prototype._onModelUnloaded=function(e){var t,n,r,i,s,o,u;this.ee=null,u=this.__kb.callbacks;for(n in u){t=u[n],e.unbind(n,t.fn),i=t.list;for(s=0,o=i.length;s<o;s++)r=i[s],r.rel_fn&&this._modelUnbindRelatationalInfo(n,r),r.emitter&&r.emitter(null)}},t.prototype._modelBindRelatationalInfo=function(e,t){var n,r;if(e==="change"&&t.key&&t.update){n=y.utils.unwrapObservable(t.key),r=x.find(this.ee.getRelations(),function(e){return e.key===n});if(!r)return;t.rel_fn=function(n){return!g.statistics||h(n,""+e+" (relational)",t),t.update()},r.collectionType||x.isArray(r.keyContents)?(t.is_collection=!0,this.ee.bind("add:"+t.key,t.rel_fn),this.ee.bind("remove:"+t.key,t.rel_fn)):this.ee.bind("update:"+t.key,t.rel_fn)}},t.prototype._modelUnbindRelatationalInfo=function(e,t){if(!t.rel_fn)return;t.is_collection?(this.ee.unbind("add:"+t.key,t.rel_fn),this.ee.unbind("remove:"+t.key,t.rel_fn)):this.ee.unbind("update:"+t.key,t.rel_fn),t.rel_fn=null},t}(),g.emitterObservable=function(e,t){return new g.EventWatcher(e,t)},g.Observable=function(){function e(e,t,n){var r,i,s,o=this;return this.vm=n,t||E(this,"options"),this.vm||(this.vm={}),x.isString(t)||y.isObservable(t)?r=this.create_options={key:t}:r=this.create_options=m(t),this.key=r.key,delete r.key,this.key||E(this,"key"),!r.args||(this.args=r.args,delete r.args),!r.read||(this.read=r.read,delete r.read),!r.write||(this.write=r.write,delete r.write),i=r.event_watcher,delete r.event_watcher,this.vo=y.observable(null),this._model=y.observable(),s=g.utils.wrappedObservable(this,y.dependentObservable({read:function(){var e,t,n,r,i,s;t=[y.utils.unwrapObservable(o.key)];if(o.args)if(x.isArray(o.args)){s=o.args;for(r=0,i=s.length;r<i;r++)e=s[r],t.push(y.utils.unwrapObservable(e))}else t.push(y.utils.unwrapObservable(o.args));return o._mdl===o._model()&&o._mdl&&(n=o.read?o.read.apply(o.vm,t):o._mdl.get.apply(o._mdl,t),o.update(n)),y.utils.unwrapObservable(o.vo())},write:function(e){var t,n,r,i,s,u,a;i=N(e),r={},r[y.utils.unwrapObservable(o.key)]=i,n=o.write?[i]:[r];if(o.args)if(x.isArray(o.args)){a=o.args;for(s=0,u=a.length;s<u;s++)t=a[s],n.push(y.utils.unwrapObservable(t))}else n.push(y.utils.unwrapObservable(o.args));return o._mdl&&(o.write?o.write.apply(o.vm,n):o._mdl.set.apply(o._mdl,n)),o.update(e)},owner:this.vm})),s.__kb_is_o=!0,r.store=g.utils.wrappedStore(s,r.store),r.path=g.utils.pathJoin(r.path,this.key),r.factories&&(typeof r.factories=="function"||r.factories.create)?(r.factory=g.utils.wrappedFactory(s,new g.Factory(r.factory)),r.factory.addPathMapping(r.path,r.factories)):r.factory=g.Factory.useOptionsOrCreate(r,s,r.path),delete r.factories,s.value=x.bind(this.value,this),s.valueType=x.bind(this.valueType,this),s.destroy=x.bind(this.destroy,this),s.model=this.model=y.dependentObservable({read:function(){return o._model(),o._mdl},write:function(e){if(o.__kb_destroyed||o._mdl===e)return;return o._mdl=e,o.update(null),o._model(e)}}),g.EventWatcher.useOptionsOrCreate({event_watcher:i},e,this,{emitter:this.model,update:x.bind(this.update,this),key:this.key,path:r.path}),this.__kb_value||this.update(),g.LocalizedObservable&&r.localizer&&(s=new r.localizer(s),delete r.localizer),g.DefaultObservable&&r.hasOwnProperty("default")&&(s=g.defaultObservable(s,r["default"]),delete r["default"]),s}return e.prototype.destroy=function(){var e;return e=g.utils.wrappedObservable(this),this.__kb_destroyed=!0,g.release(this.__kb_value),this.__kb_value=null,this.model.dispose(),e.model=null,g.utils.wrappedDestroy(this)},e.prototype.value=function(){return this.__kb_value},e.prototype.valueType=function(){var e;return e=this._mdl?this._mdl.get(this.key):null,this.value_type||this._updateValueObservable(e),this.value_type},e.prototype.update=function(e){var t,n;if(this.__kb_destroyed)return;this._mdl&&!arguments.length&&(e=this._mdl.get(y.utils.unwrapObservable(this.key))),e!==void 0||(e=null),t=g.utils.valueType(e);if(!this.__kb_value||this.__kb_value.__kb_destroyed||this.__kb_value.__kb_null&&e)this.__kb_value=void 0,this.value_type=void 0;n=this.__kb_value;if(x.isUndefined(this.value_type)||this.value_type!==t&&t!==f)return this.value_type===o&&t===s?n(e):this._updateValueObservable(e);if(this.value_type===u){if(typeof n.model=="function"){if(n.model()!==e)return n.model(e)}else if(g.utils.wrappedObject(n)!==e)return this._updateValueObservable(e)}else if(this.value_type===o){if(n.collection()!==e)return n.collection(e)}else if(n()!==e)return n(e)},e.prototype._updateValueObservable=function(e){var t,n,r,i;return t=this.create_options,t.creator=g.utils.inferCreator(e,t.factory,t.path,this._mdl,this.key),this.value_type=f,n=t.creator,r=this.__kb_value,this.__kb_value=void 0,r&&g.release(r),n?t.store?i=t.store.findOrCreate(e,t):n.models_only?(i=e,this.value_type=a):n.create?i=n.create(e,t):i=new n(e,t):x.isArray(e)?(this.value_type=s,i=y.observableArray(e)):(this.value_type=a,i=y.observable(e)),this.value_type===f&&(y.isObservable(i)?i.__kb_is_co?this.value_type=o:this.value_type=a:(this.value_type=u,typeof i.model!="function"&&g.utils.wrappedObject(i,e))),this.__kb_value=i,this.vo(i)},e}(),g.observable=function(e,t,n){return new g.Observable(e,t,n)},g.ViewModel=function(){function t(t,n,r){var i,s,o,u,a,f,l,c,h,p=this;!t||t instanceof e.Model||typeof t.get=="function"&&typeof t.bind=="function"||S(this,"not a model"),n||(n={}),r||(r={}),x.isArray(n)?n={keys:n}:n=m(n),this.__kb||(this.__kb={}),this.__kb.vm_keys={},this.__kb.model_keys={},this.__kb.view_model=x.isUndefined(r)?this:r,!n.internals||(this.__kb.internals=n.internals),!n.excludes||(this.__kb.excludes=n.excludes),g.Store.useOptionsOrCreate(n,t,this),this.__kb.path=n.path,g.Factory.useOptionsOrCreate(n,this,n.path),c=C(this,"_mdl",y.observable()),this.model=y.dependentObservable({read:function(){return c(),g.utils.wrappedObject(p)},write:function(e){var t,n;if(g.utils.wrappedObject(p)===e)return;if(p.__kb_null){!e||S(p,"model set on shared null");return}g.utils.wrappedObject(p,e),t=g.utils.wrappedEventWatcher(p);if(!t){c(e);return}t.emitter(e),p.__kb.keys||!e||!e.attributes||(n=x.difference(x.keys(e.attributes),x.keys(p.__kb.model_keys)),n&&p._createObservables(e,n)),c(e)}}),o=g.utils.wrappedEventWatcher(this,new g.EventWatcher(t,this,{emitter:this.model})),n.requires&&x.isArray(n.requires)&&(u=x.clone(n.requires)),this.__kb.internals&&(u=u?x.union(u,this.__kb.internals):x.clone(this.__kb.internals));if(n.keys)if(x.isArray(n.keys))this.__kb.keys=n.keys,u=u?x.union(u,n.keys):x.clone(n.keys);else{a={},h=n.keys;for(l in h)f=h[l],a[x.isString(f)?f:f.key?f.key:l]=!0;this.__kb.keys=x.keys(a)}else s=o.emitter(),s&&s.attributes&&(i=x.keys(s.attributes),u=u?x.union(u,i):i);u&&this.__kb.excludes&&(u=x.difference(u,this.__kb.excludes)),x.isObject(n.keys)&&!x.isArray(n.keys)&&this._mapObservables(t,n.keys),x.isObject(n.requires)&&!x.isArray(n.requires)&&this._mapObservables(t,n.requires),!n.mappings||this._mapObservables(t,n.mappings),!u||this._createObservables(t,u),!g.statistics||g.statistics.register("ViewModel",this)}return t.extend=e.Model.extend,t.prototype.destroy=function(){var e;if(this.__kb.view_model!==this)for(e in this.__kb.vm_keys)this.__kb.view_model[e]=null;return this.__kb.view_model=null,g.releaseKeys(this),g.utils.wrappedDestroy(this),!g.statistics||g.statistics.unregister("ViewModel",this)},t.prototype.shareOptions=function(){return{store:g.utils.wrappedStore(this),factory:g.utils.wrappedFactory(this)}},t.prototype._createObservables=function(e,t){var n,r,i,s,o;n={store:g.utils.wrappedStore(this),factory:g.utils.wrappedFactory(this),path:this.__kb.path,event_watcher:g.utils.wrappedEventWatcher(this)};for(s=0,o=t.length;s<o;s++){r=t[s],i=this.__kb.internals&&x.contains(this.__kb.internals,r)?"_"+r:r;if(this[i])continue;this.__kb.vm_keys[i]=!0,this.__kb.model_keys[r]=!0,n.key=r,this[i]=this.__kb.view_model[i]=g.observable(e,n,this)}},t.prototype._mapObservables=function(e,t){var n,r,i;n={store:g.utils.wrappedStore(this),factory:g.utils.wrappedFactory(this),path:this.__kb.path,event_watcher:g.utils.wrappedEventWatcher(this)};for(i in t){r=t[i];if(this[i])continue;r=x.isString(r)?{key:r}:x.clone(r),r.key||(r.key=i),this.__kb.vm_keys[i]=!0,this.__kb.model_keys[r.key]=!0,this[i]=this.__kb.view_model[i]=g.observable(e,x.defaults(r,n),this)}},t}(),g.viewModel=function(e,t,n){return new g.ViewModel(e,t,n)},g.observables=function(e,t,n){return b("kb.observables","0.16.0","Please use kb.viewModel instead"),new g.ViewModel(e,t,n)},r=0,t=-1,n=1,g.CollectionObservable=function(){function i(t,n){var r,i,s=this;return!t||t instanceof e.Collection||S(this,"not a collection"),n||(n={}),i=g.utils.wrappedObservable(this,y.observableArray([])),i.__kb_is_co=!0,this.in_edit=0,this.__kb||(this.__kb={}),this.__kb._onCollectionChange=x.bind(this._onCollectionChange,this),n=m(n),n.sort_attribute?this._comparator=y.observable(this._attributeComparator(n.sort_attribute)):(n.sorted_index&&b("sortedIndex no longer supported","0.16.7","please use comparator instead"),this._comparator=y.observable(n.comparator)),n.filters?this._filters=y.observableArray(x.isArray(n.filters)?n.filters:n.filters?[n.filters]:void 0):this._filters=y.observableArray([]),r=this.create_options={store:g.Store.useOptionsOrCreate(n,t,i)},this.path=n.path,r.factory=g.utils.wrappedFactory(i,this._shareOrCreateFactory(n)),r.path=g.utils.pathJoin(n.path,"models"),r.creator=r.factory.creatorForPath(null,r.path),r.creator&&(this.models_only=r.creator.models_only),i.destroy=x.bind(this.destroy,this),i.shareOptions=x.bind(this.shareOptions,this),i.filters=x.bind(this.filters,this),i.comparator=x.bind(this.comparator,this),i.sortAttribute=x.bind(this.sortAttribute,this),i.viewModelByModel=x.bind(this.viewModelByModel,this),i.hasViewModels=x.bind(this.hasViewModels,this),this._collection=y.observable(t),i.collection=this.collection=y.dependentObservable({read:function(){return s._collection()},write:function(e){var t;if((t=s._collection())===e)return;return t&&t.unbind("all",s.__kb._onCollectionChange),e&&e.bind("all",s.__kb._onCollectionChange),s._collection(e)}}),t&&t.bind("all",this.__kb._onCollectionChange),this._mapper=y.dependentObservable(function(){var e,t,n,r,o;e=s._comparator(),n=s._filters(),t=s._collection();if(s.in_edit)return;return i=g.utils.wrappedObservable(s),t&&(r=t.models),!r||t.models.length===0?o=[]:(n.length&&(r=x.filter(r,function(e){return!s._modelIsFiltered(e)})),e?o=x.map(r,function(e){return s._createViewModel(e)}).sort(e):s.models_only?o=n.length?r:r.slice():o=x.map(r,function(e){return s._createViewModel(e)})),s.in_edit++,i(o),s.in_edit--}),i.subscribe(x.bind(this._onObservableArrayChange,this)),!g.statistics||g.statistics.register("CollectionObservable",this),i}return i.extend=e.Model.extend,i.prototype.destroy=function(){var e,t,n;return n=g.utils.wrappedObservable(this),t=this._collection(),t&&(t.unbind("all",this.__kb._onCollectionChange),e=n(),e.splice(0,e.length)),this._mapper.dispose(),this.collection.dispose(),g.release(this._filters),n.collection=null,g.utils.wrappedDestroy(this),!g.statistics||g.statistics.unregister("CollectionObservable",this)},i.prototype.shareOptions=function(){var e;return e=g.utils.wrappedObservable(this),{store:g.utils.wrappedStore(e),factory:g.utils.wrappedFactory(e)}},i.prototype.filters=function(e){return e?this._filters(x.isArray(e)?e:[e]):this._filters([])},i.prototype.comparator=function(e){return this._comparator(e)},i.prototype.sortedIndex=function(){return b("sortedIndex no longer supported","0.16.7","please use comparator instead")},i.prototype.sortAttribute=function(e){return this._comparator(e?this._attributeComparator(e):null)},i.prototype.viewModelByModel=function(e){var t;return this.models_only?null:(t=e.hasOwnProperty(e.idAttribute)?e.idAttribute:"cid",x.find(g.utils.wrappedObservable(this)(),function(n){return n.__kb.object[t]===e[t]}))},i.prototype.hasViewModels=function(){return!this.models_only},i.prototype._shareOrCreateFactory=function(e){var t,n,r,i;t=g.utils.pathJoin(e.path,"models"),r=e.factories;if(i=e.factory)if((n=i.creatorForPath(null,t))&&(!r||r.models===n)){if(!r)return i;if(i.hasPathMappings(r,e.path))return i}return i=new g.Factory(e.factory),r&&i.addPathMappings(r,e.path),i.creatorForPath(null,t)||(e.hasOwnProperty("models_only")?e.models_only?i.addPathMapping(t,{models_only:!0}):i.addPathMapping(t,g.ViewModel):e.view_model?i.addPathMapping(t,e.view_model):e.create?i.addPathMapping(t,{create:e.create}):i.addPathMapping(t,g.ViewModel)),i},i.prototype._onCollectionChange=function(e,t){var n,r,i,s;if(this.in_edit)return;switch(e){case"reset":case"resort":return this._collection.notifySubscribers(this._collection());case"new":case"add":if(this._modelIsFiltered(t))return;return i=g.utils.wrappedObservable(this),n=this._collection(),s=this._createViewModel(t),this.in_edit++,(r=this._comparator())?(i().push(s),i.sort(r)):i.splice(n.indexOf(t),0,s),this.in_edit--;case"remove":case"destroy":return this._onModelRemove(t);case"change":if(this._modelIsFiltered(t))return this._onModelRemove(t);if(r=this._comparator())return i=g.utils.wrappedObservable(this),this.in_edit++,i.sort(r),this.in_edit--}},i.prototype._onModelRemove=function(e){var t,n;n=this.models_only?e:this.viewModelByModel(e);if(!n)return;return t=g.utils.wrappedObservable(this),this.in_edit++,t.remove(n),this.in_edit--},i.prototype._onObservableArrayChange=function(e){var t,n,r,i,s,o,u,a,f,l=this;if(this.in_edit)return;this.models_only&&(!e.length||g.utils.hasModelSignature(e[0]))||!this.models_only&&(!e.length||x.isObject(e[0])&&!g.utils.hasModelSignature(e[0]))||S(this,"incorrect type passed"),s=g.utils.wrappedObservable(this),t=this._collection();if(!t||t.models===e)return;n=this._filters().length,u=e;if(this.models_only)n&&(i=x.filter(e,function(e){return!l._modelIsFiltered(e)}));else{!n||(u=[]),i=[];for(a=0,f=e.length;a<f;a++){o=e[a],r=g.utils.wrappedObject(o);if(n){if(this._modelIsFiltered(r))continue;u.push(o)}this.create_options.store.findOrReplace(r,this.create_options.creator,o),i.push(r)}}this.in_edit++,e.length===u.length||s(u),t.reset(i),this.in_edit--},i.prototype._attributeComparator=function(e){var i;return i=function(i,s){var o,u,a;return o=y.utils.unwrapObservable(e),u=i.get(o),a=s.get(o),typeof u!="object"?u===a?r:u<a?t:n:u===a?r:u<a?t:n},this.models_only?i:function(e,t){return i(g.utils.wrappedModel(e),g.utils.wrappedModel(t))}},i.prototype._createViewModel=function(e){return this.models_only?e:this.create_options.store.findOrCreate(e,this.create_options)},i.prototype._modelIsFiltered=function(e){var t,n,r,i;n=this._filters();for(r=0,i=n.length;r<i;r++){t=n[r],t=y.utils.unwrapObservable(t);if(typeof t=="function"&&t(e)||e&&e.id===t)return!0}return!1},i}(),g.collectionObservable=function(e,t){return new g.CollectionObservable(e,t)},y.bindingHandlers.inject={init:function(e,t,n,r){return g.Inject.inject(y.utils.unwrapObservable(t()),r,e,t,n)}},g.Inject=function(){function e(){}return e.inject=function(e,t,n,r,i,s){var o,u,a;return o=function(e){var o,u,a;if(x.isFunction(e))t=new e(t,n,r,i),g.releaseOnNodeRemove(t,n);else{e.view_model&&(t=new e.view_model(t,n,r,i),g.releaseOnNodeRemove(t,n));for(o in e){a=e[o];if(o==="view_model")continue;o==="create"?a(t,n,r,i):x.isObject(a)&&!x.isFunction(a)?(u=s||a&&a.create?{}:t,t[o]=g.Inject.inject(a,u,n,r,i,!0)):t[o]=a}}return t},s?o(e):(u=(a=y.dependentObservable(function(){return o(e)}))(),a.dispose(),u)},e.injectViewModels=function(e){var t,n,r,i,s,o,u,a,f,l;a=[],o=function(e){var t,n,r,i,s;e.__kb_injected||e.attributes&&(t=x.find(e.attributes,function(e){return e.name==="kb-inject"}))&&(e.__kb_injected=!0,a.push({el:e,view_model:{},binding:t.value})),s=e.childNodes;for(r=0,i=s.length;r<i;r++)n=s[r],o(n)},o(e||document);for(f=0,l=a.length;f<l;f++){n=a[f];if(s=n.binding)s.search(/[:]/)<0||(s="{"+s+"}"),i=(new Function("","return ( "+s+" )"))(),i||(i={}),!i.options||(u=i.options,delete i.options),u||(u={}),n.view_model=g.Inject.inject(i,n.view_model,n.el,null,null,!0),t=n.view_model.afterBinding||u.afterBinding,r=n.view_model.beforeBinding||u.beforeBinding;r&&r(n.view_model,n.el,u),g.applyBindings(n.view_model,n.el,u),t&&t(n.view_model,n.el,u)}return a},e}(),g.injectViewModels=g.Inject.injectViewModels,this.$?this.$(function(){return g.injectViewModels()}):(w=function(){return document.readyState!=="complete"?setTimeout(w,0):g.injectViewModels()})(),g.DefaultObservable=function(){function e(e,t){var n,r=this;return this.dv=t,n=g.utils.wrappedObservable(this,y.dependentObservable({read:function(){var t;return(t=y.utils.unwrapObservable(e()))?t:y.utils.unwrapObservable(r.dv)},write:function(t){return e(t)}})),n.destroy=x.bind(this.destroy,this),n.setToDefault=x.bind(this.setToDefault,this),n}return e.prototype.destroy=function(){return g.utils.wrappedDestroy(this)},e.prototype.setToDefault=function(){return g.utils.wrappedObservable(this)(this.dv)},e}(),g.defaultObservable=function(e,t){return new g.DefaultObservable(e,t)},g.defaultWrapper=function(e,t){return b("ko.defaultWrapper","0.16.3","Please use kb.defaultObservable instead"),new g.DefaultObservable(e,t)},g.Observable.prototype.setToDefault=function(){var e;(e=this.__kb_value)!=null&&typeof e.setToDefault=="function"&&e.setToDefault()},g.ViewModel.prototype.setToDefault=function(){var e,t;for(e in this.__kb.vm_keys)(t=this[e])!=null&&typeof t.setToDefault=="function"&&t.setToDefault()},g.utils.setToDefault=function(e){var t,n;if(!e)return;if(y.isObservable(e))typeof e.setToDefault=="function"&&e.setToDefault();else if(x.isObject(e))for(t in e)n=e[t],n&&(y.isObservable(n)||typeof n!="function")&&(t[0]!=="_"||t.search("__kb"))&&this.setToDefault(n);return e},p=Array.prototype.slice,g.toFormattedString=function(e){var t,n,r,i,s,o;s=e.slice(),n=p.call(arguments,1);for(r in n){t=n[r],o=y.utils.unwrapObservable(t),o||(o=""),i=e.indexOf("{"+r+"}");while(i>=0)s=s.replace("{"+r+"}",o),i=e.indexOf("{"+r+"}",i+1)}return s},g.parseFormattedString=function(e,t){var n,r,i,s,o,u,a,f,l,c,h,p,d;c=t.slice(),i=0,u=0,f={};while(c.search("\\{"+i+"\\}")>=0){a=t.indexOf("{"+i+"}");while(a>=0)c=c.replace("{"+i+"}","(.*)"),f[a]=i,u++,a=t.indexOf("{"+i+"}",a+1);i++}n=i,l=new RegExp(c),o=l.exec(e),o&&o.shift();if(!o||o.length!==u){h=[];while(n-->0)h.push("");return h}d=x.sortBy(x.keys(f),function(e,t){return parseInt(e,10)}),r={};for(s in d){a=d[s],i=f[a];if(r.hasOwnProperty(i))continue;r[i]=s}p=[],i=0;while(i<n)p.push(o[r[i]]),i++;return p},g.FormattedObservable=function(){function e(e,t){var n,r;return x.isArray(t)?(e=e,r=t):r=p.call(arguments,1),n=g.utils.wrappedObservable(this,y.dependentObservable({read:function(){var n,i,s;t=[y.utils.unwrapObservable(e)];for(i=0,s=r.length;i<s;i++)n=r[i],t.push(y.utils.unwrapObservable(n));return g.toFormattedString.apply(null,t)},write:function(t){var n,i,s;i=g.parseFormattedString(t,y.utils.unwrapObservable(e)),s=Math.min(r.length,i.length),n=0;while(n<s)r[n](i[n]),n++}})),n}return e.prototype.destroy=function(){return g.utils.wrappedDestroy(this)},e}(),g.formattedObservable=function(e,t){return new g.FormattedObservable(e,p.call(arguments,1))},g.LocalizedObservable=function(){function t(e,t,n){var r,i=this;return this.value=e,this.vm=n,t||(t={}),this.vm||(this.vm={}),this.read||E(this,"read"),g.locale_manager||E(this,"kb.locale_manager"),this.__kb||(this.__kb={}),this.__kb._onLocaleChange=x.bind(this._onLocaleChange,this),this.__kb._onChange=t.onChange,this.value&&(e=y.utils.unwrapObservable(this.value)),this.vo=y.observable(e?this.read(e,null):null),r=g.utils.wrappedObservable(this,y.dependentObservable({read:function(){return i.value&&y.utils.unwrapObservable(i.value),i.vo(),i.read(y.utils.unwrapObservable(i.value))},write:function(e){i.write||S(i,"writing to read-only"),i.write(e,y.utils.unwrapObservable(i.value)),i.vo(e);if(i.__kb._onChange)return i.__kb._onChange(e)},owner:this.vm})),r.destroy=x.bind(this.destroy,this),r.observedValue=x.bind(this.observedValue,this),r.resetToCurrent=x.bind(this.resetToCurrent,this),g.locale_manager.bind("change",this.__kb._onLocaleChange),t.hasOwnProperty("default")&&(r=g.DefaultObservable&&y.defaultObservable(r,t["default"])),r}return t.extend=e.Model.extend,t.prototype.destroy=function(){return g.locale_manager.unbind("change",this.__kb._onLocaleChange
),this.vm=null,g.utils.wrappedDestroy(this)},t.prototype.resetToCurrent=function(){var e,t;t=g.utils.wrappedObservable(this),e=this.value?this.read(y.utils.unwrapObservable(this.value)):null;if(t()===e)return;return t(e)},t.prototype.observedValue=function(e){if(arguments.length===0)return this.value;this.value=e,this._onLocaleChange()},t.prototype._onLocaleChange=function(){var e;e=this.read(y.utils.unwrapObservable(this.value)),this.vo(e);if(this.__kb._onChange)return this.__kb._onChange(e)},t}(),g.localizedObservable=function(e,t,n){return new g.LocalizedObservable(e,t,n)},g.locale_manager=void 0,g.TriggeredObservable=function(){function e(e,t){var n,r=this;return this.event_selector=t,e||E(this,"emitter"),this.event_selector||E(this,"event_selector"),this.vo=y.observable(),n=g.utils.wrappedObservable(this,y.dependentObservable(function(){return r.vo()})),n.destroy=x.bind(this.destroy,this),g.utils.wrappedEventWatcher(this,new g.EventWatcher(e,this,{emitter:x.bind(this.emitter,this),update:x.bind(this.update,this),event_selector:this.event_selector})),n}return e.prototype.destroy=function(){return g.utils.wrappedDestroy(this)},e.prototype.emitter=function(e){if(arguments.length===0||this.ee===e)return this.ee;if(this.ee=e)return this.update()},e.prototype.update=function(){if(!this.ee)return;return this.vo()!==this.ee?this.vo(this.ee):this.vo.valueHasMutated()},e}(),g.triggeredObservable=function(e,t){return new g.TriggeredObservable(e,t)},v=function(e){return e=y.utils.unwrapObservable(e),typeof e=="function"?e.apply(null,Array.prototype.slice.call(arguments,1)):e},g.Validation=function(){function e(){}return e.valueValidator=function(e,t,n){return n==null&&(n={}),n&&typeof n!="function"||(n={}),y.dependentObservable(function(){var r,i,s,o,u,a,f,l;f={$error_count:0},i=y.utils.unwrapObservable(e),!("disable"in n)||(s=v(n.disable)),!("enable"in n)||(s=!v(n.enable)),a=n.priorities||[],x.isArray(a)||(a=[a]),r=a.length+1;for(o in t)l=t[o],f[o]=!s&&v(l,i),f[o]&&(f.$error_count++,(u=x.indexOf(a,o)>=0)||(u=a.length),f.$active_error&&u<r?(f.$active_error=o,r=u):f.$active_error||(f.$active_error=o,r=u));return f.$enabled=!s,f.$disable=!!s,f.$valid=f.$error_count===0,f})},e.inputValidator=function(e,t,n){var r,i,s,o,u,a,f,l,c;return n&&typeof n!="function"||(n={}),c=g.valid,r=$(t),(o=r.attr("name"))&&!x.isString(o)&&(o=null),(i=r.attr("data-bind"))?(u=(new Function("sc","with(sc[0]) { return { "+i+" } }"))([e]),!u||!u.value?null:(!u.validation_options||(x.defaults(u.validation_options,n),n=u.validation_options),i={},!c[f=r.attr("type")]||(i[f]=c[f]),!r.attr("required")||(i.required=c.required),!u.validations||function(){var e,t;e=u.validations,t=[];for(s in e)l=e[s],t.push(i[s]=l);return t}(),a=g.valueValidator(u.value,i,n),!o&&!n.no_attach||(e["$"+o]=a),a)):null},e.formValidator=function(e,t){var n,r,i,s,o,u,a,f,l,c,h,p,d;a={},c=[],n=$(t),(i=n.attr("name"))&&!x.isString(i)&&(i=null);if(r=n.attr("data-bind"))u=(new Function("sc","with(sc[0]) { return { "+r+" } }"))([e]),f=u.validation_options;f||(f={}),f.no_attach=!!i,d=n.find("input");for(h=0,p=d.length;h<p;h++){s=d[h];if(!(o=$(s).attr("name")))continue;l=g.inputValidator(e,s,f),!l||c.push(a[o]=l)}return a.$error_count=y.dependentObservable(function(){var e,t,n;e=0;for(t=0,n=c.length;t<n;t++)l=c[t],e+=l().$error_count;return e}),a.$valid=y.dependentObservable(function(){return a.$error_count()===0}),a.$enabled=y.dependentObservable(function(){var e,t,n;e=!0;for(t=0,n=c.length;t<n;t++)l=c[t],e&=l().$enabled;return e}),a.$disabled=y.dependentObservable(function(){return!a.$enabled()}),i&&(e["$"+i]=a),a},e}(),g.valueValidator=g.Validation.valueValidator,g.inputValidator=g.Validation.inputValidator,g.formValidator=g.Validation.formValidator,c=/^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,i=/^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}$/,l=/^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,g.valid={required:function(e){return!e},url:function(e){return!c.test(e)},email:function(e){return!i.test(e)},number:function(e){return!l.test(e)}},g.hasChangedFn=function(e){var t,n;return n=null,t=null,function(){var r;return n!==(r=y.utils.unwrapObservable(e))?(n=r,t=n?n.toJSON():null,!1):!n||!t?!1:!x.isEqual(n.toJSON(),t)}},g.minLengthFn=function(e){return function(t){return!t||t.length<e}},g.uniqueValueFn=function(e,t,n){return function(r){var i,s,o,u=this;return o=y.utils.unwrapObservable(e),s=y.utils.unwrapObservable(t),i=y.utils.unwrapObservable(n),o&&s&&i?!!x.find(i.models,function(e){return e!==o&&e.get(s)===r}):!1}},g.untilTrueFn=function(e,t,n){var r;return r=!1,n&&y.isObservable(n)&&n.subscribe(function(){return r=!1}),function(n){var i,s;return(i=y.utils.unwrapObservable(t))?(r|=!!(s=i(y.utils.unwrapObservable(n))),r?s:y.utils.unwrapObservable(e)):y.utils.unwrapObservable(e)}},g.untilFalseFn=function(e,t,n){var r;return r=!1,n&&y.isObservable(n)&&n.subscribe(function(){return r=!1}),function(n){var i,s;return(i=y.utils.unwrapObservable(t))?(r|=!(s=i(y.utils.unwrapObservable(n))),r?s:y.utils.unwrapObservable(e)):y.utils.unwrapObservable(e)}},g})}).call(this);