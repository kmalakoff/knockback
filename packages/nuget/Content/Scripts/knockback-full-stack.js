          ...
          module.exports = kb = (function () {
            ...
            kb.release = function (obj) {
              ...
              if (ko.isObservable(obj) && _.isArray((array = kb.peek(obj)))) {
                if (
                  obj.__kb_is_co ||
                  (obj.__kb_is_o && obj.valueType() === kb.TYPE_COLLECTION)
                ) {
            ...
            kb.renderTemplate = function (template, view_model, options) {
              ...
              if (el.childNodes.length === 1) {
                ...
                for (
                  i = _i = 0, _ref = el.childNodes.length;
            ...
            kb.applyBindings = function (view_model, node) {
              ...
              if (node.length) {
                (_ref = [document.createElement("div"), node]),
                  (node = _ref[0]),
                  (children = _ref[1]);
            ...
            kb.getValue = function (model, key, args) {
              ...
              if (
                ...
                ((_ref = kb.settings.orm) != null
                  ? _ref.useFunction(model, key)
                  : void 0)
              ) {
                return model[key]();
              }
            ...
            kb.ignore =
              ((_ref = ko.dependencyDetection) != null
                ? _ref.ignore
                : void 0) ||
            ...
            kb._throwMissing = function (instance, message) {
              throw (
                "" +
                (_.isString(instance) ? instance : instance.constructor.name) +
                ": " +
                message +
                " is missing"
              );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports = TypedValue = (function () {
          ...
          TypedValue.prototype.update = function (new_value) {
            ...
            if (
              (_ref1 = this.__kb_value) != null ? _ref1.__kb_released : void 0
            ) {
          ...
          TypedValue.prototype._updateValueObservable = function (
            new_value,
            new_observable
          ) {
            var create_options,
            ...
            (_ref1 = [this.__kb_value, void 0]),
              (previous_value = _ref1[0]),
              (this.__kb_value = _ref1[1]);
            if (new_observable) {
        ...
        kb.CollectionObservable = (function () {
          ...
          function CollectionObservable(collection, view_model, options) {
            ...
            return kb.ignore(function () {
              ...
              !kb.statistics ||
                kb.statistics.register("CollectionObservable", _this);
              return observable;
            });
          }
          ...
          CollectionObservable.prototype.sortAttribute = function (
            ...
            return this._comparator(
              sort_attribute ? this._attributeComparator(sort_attribute) : null
            );
          };
          ...
          CollectionObservable.prototype._shareOrCreateFactory = function (
            options
          ) {
            ...
            return kb.ignore(function () {
              ...
              switch (event) {
                ...
                case "change":
                  ...
                  view_model = _this.models_only
                    ? arg
                    : _this.viewModelByModel(arg);
                  if (!view_model) {
          ...
          CollectionObservable.prototype._onObservableArrayChange = function (
            ...
            return kb.ignore(function () {
                ...
                (!_this.models_only &&
                  (!models_or_view_models.length ||
                    (_.isObject(models_or_view_models[0]) &&
                      !kb.isModel(models_or_view_models[0])))) ||
                kb._throwUnexpected(_this, "incorrect type passed");
              observable = kb.utils.wrappedObservable(_this);
              ...
              if (_this.models_only) {
                ...
                models = [];
                for (
                  _i = 0, _len = models_or_view_models.length;
                  _i < _len;
                  _i++
                ) {
                  ...
                  if (
                    (current_view_model = _this.create_options.store.find(
                      model,
                      _this.create_options.creator
                    ))
                  ) {
                    current_view_model.constructor === view_model.constructor ||
                      kb._throwUnexpected(
                        _this,
                        "replacing different type of view model"
                      );
                  }
                  _this.create_options.store.retain(
                    view_model,
                    model,
                    _this.create_options.creator
                  );
          ...
          CollectionObservable.prototype._attributeComparator = function (
            sort_attribute
          ) {
...
*/
        ...
        kb.EventWatcher = (function () {
          EventWatcher.useOptionsOrCreate = function (
            options,
            emitter,
            obj,
            callback_options
          ...
          EventWatcher.prototype.registerCallbacks = function (
            obj,
            callback_info
          ) {
            var event_name,
          ...
          EventWatcher.prototype._onModelLoaded = function (model) {
            ...
            for (event_name in _ref1) {
              ...
              for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
                ...
                info.unbind_fn ||
                  (info.unbind_fn =
                    (_ref3 = kb.settings.orm) != null
                      ? _ref3.bind(model, info.key, info.update, info.path)
                      : void 0);
                if (info.emitter) {
                  info.emitter(model);
                }
          ...
          EventWatcher.prototype._unbindCallbacks = function (
            event_name,
            callbacks,
            skip_emitter
          ) {
        ...
        module.exports = kb.Statistics = (function () {
          ...
          Statistics.prototype.unregister = function (key, obj) {
            ...
            if ((index = _.indexOf(type_tracker, obj)) < 0) {
              return typeof console !== "undefined" && console !== null
                ? console.log(
                    "kb.Statistics: failed to unregister type: " + key
                  )
                : void 0;
            }
          ...
          Statistics.prototype.registeredStatsString = function (
            success_message
          ) {
            ...
            for (type in _ref) {
              ...
              stats_string +=
                "" + (type ? type : "No Name") + ": " + type_tracker.length;
              written = true;
            }
            if (stats_string) {
              return stats_string;
        ...
        module.exports = kb.Store = (function () {
          ...
          Store.prototype.clear = function () {
            ...
            (_ref1 = [this.observable_records, {}]),
              (observable_records = _ref1[0]),
              (this.observable_records = _ref1[1]);
            ...
            (_ref2 = [this.replaced_observables, []]),
          ...
          Store.prototype.retainOrCreate = function (
            obj,
            options,
            deep_retain
          ) {
          ...
          Store.prototype.reuse = function (observable, obj) {
            ...
            creator =
              kb.utils.wrappedCreator(observable) || observable.constructor;
          ...
          Store.prototype.find = function (obj, creator) {
            ...
            if (
              !(records = this.observable_records[this._creatorId(creator)])
            ) {
              return null;
            }
            if (
              (_ref1 = observable = records[this._cid(obj)]) != null
                ? _ref1.__kb_released
                : void 0
            ) {
          ...
          Store.prototype._add = function (observable, obj, creator) {
            ...
            return (((_base = this.observable_records)[
              (_name = this._creatorId(creator))
            ] || (_base[_name] = {}))[this._cid(obj)] = observable);
          };
          ...
          Store.prototype._remove = function (observable) {
            ...
            if (
              ...
              if (current_observable === observable) {
                delete this.observable_records[this._creatorId(creator)][
                  this._cid(obj)
                ];
              }
            }
...
*/
        ...
        kb.ViewModel = (function () {
          ...
          ViewModel.prototype.destroy = function () {
            ...
            kb.utils.wrappedDestroy(this);
            return (
              !kb.statistics || kb.statistics.unregister("ViewModel", this)
            );
          };
          ...
          ViewModel.prototype.createObservables = function (model, keys) {
            ...
            if (!keys) {
              ...
              if (
                (rel_keys =
                  (_ref1 = kb.settings.orm) != null
                    ? typeof _ref1.keys === "function"
                      ? _ref1.keys(model)
                      : void 0
                    : void 0)
              ) {
        ...
        kb.valueValidator = function (value, bindings, validation_options) {
          ...
          return ko.computed(function () {
            ...
            for (identifier in bindings) {
              ...
              results[identifier] =
                !disabled && callOrGet(validator, current_value);
        ...
        module.exports = BackboneAssociations = (function () {
          ...
          BackboneAssociations.isAvailable = function () {
            return !!(AssociatedModel =
              Backbone != null ? Backbone.AssociatedModel : void 0);
          };
        ...
        module.exports = BackboneRelational = (function () {
          ...
          BackboneRelational.isAvailable = function () {
            return !!(RelationalModel =
              Backbone != null ? Backbone.RelationalModel : void 0);
          };
            ...
            (function (p) {
              true
                ? !((__WEBPACK_AMD_DEFINE_ARRAY__ = [
                  ...
                  (__WEBPACK_AMD_DEFINE_FACTORY__ = p),
                  (__WEBPACK_AMD_DEFINE_RESULT__ =
                  ...
                  Nd: function (c, d, e) {
                    ...
                    if ("object" == typeof c && "form" === a.a.P(c))
                      for (var l = c.action, h = f.length - 1; 0 <= h; h--)
                        for (
                          var g = a.a.Kc(c, f[h]), m = g.length - 1;
                          0 <= m;
                          m--
                        )
                ...
                a.a.dc = function (b, c) {
                  ...
                  if (null !== c && c !== p)
                    if (("string" != typeof c && (c = c.toString()), v))
                      ...
                      for (
                        var d = a.a.ta(c, b.ownerDocument), e = 0;
                        e < d.length;
                        e++
                      )
                        b.appendChild(d[e]);
              ...
              var D = {
                ...
                tb: function (b) {
                  var c = this,
                    ...
                    m;
                  c.bb ||
                    ((c.bb = c.notifySubscribers), (c.notifySubscribers = Z));
                  var l = b(function () {
                    c.Ka = !1;
                    d && h === c && (h = c.mc ? c.mc() : c());
                    var a = f || (m && c.qb(g, h));
                  ...
                  cb: function (b) {
                    ...
                    c.qa ||
                      ...
                      (a.a.O(c.F, function (a, b) {
                        b.s &&
                          ((c.F[a] = { da: b.da, La: b.La, Ma: b.Ma }), b.s());
                      }),
                      (c.G = !0),
                ...
                a.h = {
                  ...
                  ua: function (c, d) {
                    if (b(c)) {
                      a.h.Ea(c);
                      for (
                        var e = c.nextSibling, f = 0, l = d.length;
                        f < l;
                        f++
                      )
                ...
                function b(b, d, e) {
                  a.f[b] = {
                    init: function (b, c, h, m, l) {
                      ...
                      p =
                        (r = "render" == h.get("completeOn")) || h.has(a.j.oa);
                      a.o(
                        function () {
                          var h = a.a.c(c()),
                            m = !e !== !h,
              ...
              a.f.options = {
                ...
                update: function (b, c, d) {
                  ...
                  d.has("optionsAfterRender") &&
                    ...
                    (l = function (b, c) {
                      g(0, c);
                      a.v.K(d.get("optionsAfterRender"), null, [
                        c[0],
                        b !== Q ? b : p,
                      ]);
                    });
                ...
                a.B.D.prototype.nodes = function () {
                  ...
                  if (0 == arguments.length) {
                    var e = a.a.g.get(b, c) || {},
                      f =
                        e.jb ||
                        (3 === this.Db ? b.content : 4 === this.Db ? b : p);
                    if (!f || e.hd)
                      if ((e = this.text()))
                    ...
                    (r = l[k][n] - 1),
                      n && r === l[k][n - 1]
                        ...
                        : (--n,
                          --k,
                          g.sparse ||
                            h.push({ status: "retained", value: d[n] }));
                  ...
                  var l = [],
                    k = a.$(
                      function () {
                        ...
                        0 < l.length &&
                          (a.a.Wc(l, k), h && a.v.K(h, null, [d, k, m]));
                        l.length = 0;
                        a.a.gb(l, k);
                      },
                      null,
