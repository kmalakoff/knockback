...
(function() {
  ...
  */
  ...
  kb.Store = (function() {
    ...
    Store.prototype.findObservable = function(obj, factory, path) {
    ...
    Store.prototype.resolveObservable = function(obj, factory, path) {
      var index, observable;
      index = this.findObservable(obj, factory, path);
      if (index >= 0) {
  ...
  */
  ...
  kb.CollectionObservable = (function(_super) {
    ...
    CollectionObservable.prototype._createTarget = function(model) {
      if (this.hasViewModels()) {
        return this.__kb.store.resolveObservable(model, this.__kb.factory, this.__kb.models_path);
      } else {
        return model;
      }
    };
  ...
  kb.AttributeObservable = (function() {
    ...
    AttributeObservable.prototype.destroy = function() {
      if (this.__kb.value_observable) {
        this.__kb.options.store.releaseObservable(this.__kb.value_observable);
      }
      kb.utils.wrappedObservable(this).dispose();
      kb.utils.wrappedObservable(this, null);
      return this.__kb = null;
    ...
    AttributeObservable.prototype.write = function(new_value) {
      ...
      if (model && model.get(this.__kb.options.path) !== new_value) {
        set_info = {};
        set_info[this.__kb.options.path] = new_value;
        model.set(set_info);
      }
    ...
    AttributeObservable.prototype.update = function(new_value) {
      ...
      if (model && !arguments.length) {
        new_value = model.get(this.__kb.options.path);
      }
      if (!this.__kb.value_observable) {
    ...
    AttributeObservable.prototype._createValueObservable = function(new_value, notify) {
      ...
      this.__kb.value_observable = this.__kb.options.factory ? this.__kb.options.factory.createForPath(new_value, this.__kb.options.path, this.__kb.options.store) : kb.Factory.createDefault(new_value, this.__kb.options);
      if (notify) {
  ...
  */
  ...
  kb.ViewModel = (function(_super) {
    ...
    ViewModel.prototype._updateAttributeObservable = function(model, key) {
      ...
      if (this[vm_key]) {
        if (this[vm_key].model() !== model) {
          return this[vm_key].model(model);
        } else {
          return this[vm_key].update();
        }
      } else {
