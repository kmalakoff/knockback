...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["kb"] = factory(root["Backbone"], root["_"], root["ko"]);
})(
  this,
  function (
...
*/
          ...
          kb.Factory = (function () {
            ...
            Factory.prototype.addPathMappings = function (
              factories,
              owner_path
            ) {
            ...
            Factory.prototype.hasPathMappings = function (
              factories,
              owner_path
            ) {
                ...
                observable = kb.utils.wrappedObservable(
                  ...
                  ko.computed({
                    read: function () {
                      ...
                      if (
                        (_ref2 = kb.utils.wrappedEventWatcher(_this)) != null
                      ) {
...
*/
          ...
          module.exports = kb.Statistics = (function () {
            ...
            Statistics.prototype.modelEventsStatsString = function () {
              ...
              stats_string = "";
              stats_string +=
                "Total Count: " + this.model_events_tracker.length;
...
*/
          ...
          module.exports = kb.Store = (function () {
            ...
            Store.prototype.clear = function () {
              ...
              for (
                _i = 0, _len = replaced_observables.length;
                _i < _len;
                _i++
              ) {
            ...
            Store.prototype._getOrCreateStoreReferences = function (
              observable
            ) {
              var store_references,
                stores_references,
...
*/
          ...
          kb.utils = (function () {
            ...
            utils.collapseOptions = __webpack_require__(20);
              ...
              observable = kb.utils.wrappedObservable(
                ...
                ko.computed({
                  read: function () {
                    ...
                    for (
                      _i = 0, _len = observable_args.length;
                      _i < _len;
                      _i++
                    ) {
...
*/
          ...
          kb.valueValidator = function (value, bindings, validation_options) {
            ...
            (validation_options &&
              !(typeof validation_options === "function")) ||
              (validation_options = {});
