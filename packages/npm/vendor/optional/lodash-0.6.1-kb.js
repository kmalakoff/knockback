...
/*kb  lodash.after = after; kb*/
  lodash.bind = bind;
  lodash.bindAll = bindAll;
  lodash.chain = chain;
  lodash.clone = clone;
  lodash.compact = compact;
/*kb  lodash.compose = compose; kb*/
  lodash.contains = contains;
/*kb  lodash.debounce = debounce; kb*/
  lodash.defaults = defaults;
  lodash.defer = defer;
  lodash.delay = delay;
  lodash.difference = difference;
/*kb  lodash.drop = drop; kb*/
  lodash.escape = escape;
  lodash.every = every;
  lodash.extend = extend;
  lodash.filter = filter;
  lodash.find = find;
/*kb  lodash.first = first; kb*/
...
/*kb  lodash.initial = initial; kb*/
  lodash.intersection = intersection;
/*kb  lodash.invoke = invoke; kb*/
  ...
  lodash.keys = keys;
  lodash.last = last;
/*kb  lodash.lastIndexOf = lastIndexOf; kb*/
  lodash.map = map;
/*kb  lodash.max = max; kb*/
/*kb  lodash.memoize = memoize; kb*/
/*kb  lodash.min = min; kb*/
  lodash.mixin = mixin;
  lodash.noConflict = noConflict;
/*kb  lodash.once = once; kb*/
  lodash.partial = partial;
/*kb  lodash.pick = pick; kb*/
  lodash.pluck = pluck;
/*kb  lodash.range = range; kb*/
  lodash.reduce = reduce;
/*kb  lodash.reduceRight = reduceRight; kb*/
  lodash.reject = reject;
/*kb  lodash.rest = rest; kb*/
/*kb  lodash.result = result; kb*/
/*kb  lodash.shuffle = shuffle; kb*/
  lodash.size = size;
  lodash.some = some;
  lodash.sortBy = sortBy;
  lodash.sortedIndex = sortedIndex;
/*kb  lodash.tap = tap; kb*/
/*kb  lodash.template = template; kb*/
/*kb  lodash.throttle = throttle; kb*/
/*kb  lodash.times = times; kb*/
  lodash.toArray = toArray;
/*kb  lodash.unescape = unescape; kb*/
  lodash.union = union;
  lodash.uniq = uniq;
  lodash.uniqueId = uniqueId;
  lodash.values = values;
/*kb  lodash.where = where; kb*/
  lodash.without = without;
/*kb  lodash.wrap = wrap; kb*/
/*kb  lodash.zip = zip; kb*/
/*kb  lodash.zipObject = zipObject; kb*/
  ...
  lodash.each = forEach;
  lodash.foldl = reduce;
/*kb  lodash.foldr = reduceRight; kb*/
/*kb  lodash.head = first; kb*/
  lodash.include = contains;
  lodash.inject = reduce;
  lodash.methods = functions;
/*kb  lodash.omit = drop; kb*/
  lodash.select = filter;
/*kb  lodash.tail = rest; kb*/
/*kb  lodash.take = first; kb*/
  lodash.unique = uniq;
