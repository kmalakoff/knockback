...
KNOCKBACK_TESTS["knockback_core_#{core_name}"] = [REQUIRED_DEPENDENCIES.latest, KNOCKBACK.core, core_files] for core_name, core_files of CORE
KNOCKBACK_TESTS["knockback_core_min_#{core_name}"] = [REQUIRED_DEPENDENCIES.latest, KNOCKBACK.core_min, core_files] for core_name, core_files of CORE
...
for dep_name, dep_files of _.pick(REQUIRED_DEPENDENCIES, 'latest')
