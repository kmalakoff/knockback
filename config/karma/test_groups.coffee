...
LOCALIZATION = ['./_temp/knockback-examples-localization.js', './vendor/test/globalize/globalize.js', './vendor/test/globalize/globalize.culture.en-GB.js', './vendor/test/globalize/globalize.culture.fr-FR.js']
...
###############################
COMMONJS_TESTS =
  latest: ['./vendor/test/jquery-1.11.1.min.js', './_temp/bundle-commonjs-latest.js', './lib/knockback-statistics.js', LOCALIZATION, MODEL_REF, './test/knockback/**/*.tests.coffee']
...
###############################
STACK_TESTS =
  lodash: ['./vendor/test/jquery-1.11.1.min.js', './_temp/bundle-full-stack-lodash.js', './lib/knockback-statistics.js', LOCALIZATION, MODEL_REF, './test/knockback/**/*.tests.coffee']
  underscore: ['./vendor/test/jquery-1.11.1.min.js', './_temp/bundle-full-stack-underscore.js', './lib/knockback-statistics.js', LOCALIZATION, MODEL_REF, './test/knockback/**/*.tests.coffee']
