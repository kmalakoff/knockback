...
Knockback.CollectionObservable = (function(_super) {
  ...
  CollectionObservable.prototype._createTarget = function(model) {
    ...
    return this.__kb.store.resolve(model, function() {
      var options, view_model;
      options = _this.__kb.store.addResolverToOptions({}, model);
      view_model = _this.view_model_create_with_new ? new _this.view_model_create_fn(model, options) : _this.view_model_create_fn(model, options);
  ...
  CollectionAttributeConnector.prototype.update = function() {
    ...
    if (!current_value) {
      if (this.options.__kb_store) {
        return this.__kb.value_observable(this.options.__kb_store.resolve(value, function() {
  ...
  ViewModelAttributeConnector.prototype.update = function() {
    ...
    if (!current_value) {
      ...
      if (view_model_options.__kb_store) {
        return this.__kb.value_observable(view_model_options.__kb_store.resolve(value, function() {
