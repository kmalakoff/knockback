...
describe('Knockback.js with Backbone-Relational.js @backbone-relational', function () {
  ...
  it('2. Collection with models with HasMany relations: Multiple houses with multiple people living in them', function (done) {
    ...
    const _paul = new Person({
      id: 'person-2-2',
      name: 'Paul',
    });
    const _george = new Person({
      id: 'person-2-3',
      name: 'George',
    });
    const _ringo = new Person({
      id: 'person-2-4',
      name: 'Ringo',
    });
  ...
  it('5. bug fix for relational models https://github.com/kmalakoff/knockback/issues/34', function (done) {
    ...
    const bs = new BookStore({
      books: [
        { _id: 'b1', name: 'Book One', author: 'a1' },
        { _id: 'b2', name: 'Book Two', author: 'a1' },
      ],
      authors: [
        { name: 'fred', _id: 'a1' },
        { name: 'ted', _id: 'a2' },
  ...
  it('12. Issue 96', function (done) {
    ...
    const filter_group_model = new FilterGroup({
      Filters: [
  ...
  it('14. Issue 122', function (done) {
    ...
    class ViewModel extends kb.ViewModel {
      constructor(model, options) {
        ...
        this.hasNested = ko.computed(() => !!__guard__(this.nested(), (x) => x.model()));
      }
    }
