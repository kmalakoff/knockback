...
describe('Knockback.js with Backbone-Associations.js @backbone-associations', function () {
  ...
  it.skip('8b. Customizing observable types: from the start (attribute setting)', function (done) {
    kb.statistics = new kb.Statistics(); // turn on stats
  ...
  // TODO: put back when test why running both Backbone.Relational and this together fail
  it.skip('11. Minimum factory tree for shared dependent models', function (done) {
    kb.statistics = new kb.Statistics(); // turn on stats
