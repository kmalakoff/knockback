...
describe('Knockback.js with BackboneORM @backbone-orm', function() {
  ...
  it.skip('5. bug fix for relational models https://github.com/kmalakoff/knockback/issues/34', function(done) {
  ...
  it('8b. Customizing observable types: from the start (attribute setting)', function(done) {
    ...
    const models = [person1, person2];
    for (let model of models) { model.save(function() {}); }
  ...
  it('10. Nested custom view models', function(done) {
    ...
    const models = [george, john, paul, ringo];
    for (var model of models) { model.save(function() {}); }
    for (model of models) { model.fetchRelated(function() {}); }
