...
describe('Knockback.js with Backbone.ModelRef.js @backbone-modelref', function () {
  ...
  if (!(root.Backbone != null ? root.Backbone.ModelRef : undefined)) {
    return;
  }
  ...
  it('Standard use case with kb.ViewModels', function (done) {
    kb.statistics = new kb.Statistics(); // turn on stats
  ...
  return it('CLEANUP', () => (Backbone.ModeRef = undefined));
});
