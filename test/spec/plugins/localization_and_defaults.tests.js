...
describe('localized-observable @quick @localization', function() {
  ...
  it.skip('3. internals test (Javascript inheritance)', function(done) {
    kb.statistics = new kb.Statistics(); // turn on stats
    kb.locale_manager = locale_manager;
...
describe('defaults @quick @defaults', function() {
  ...
  if (kb.Backbone) {
    it.skip('1. Standard use case: just enough to get the picture', function(done) {
      kb.statistics = new kb.Statistics(); // turn on stats
      kb.locale_manager = locale_manager;
  ...
  it('3. internals test (Coffeescript inheritance)', function(done) {
    kb.statistics = new kb.Statistics(); // turn on stats
    kb.locale_manager = locale_manager;
