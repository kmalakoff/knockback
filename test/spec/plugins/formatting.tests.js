...
describe('formatted-observable @quick @formatting', function() {
  ...
  it('Various scenarios', function(done) {
    ...
    class ContactViewModelCustom extends kb.ViewModel {
      constructor(model) {
        ...
        this.name = ko.computed(() => { return `Name: ${this._name()}`; });
  ...
  it('kb.formattedObservable', function(done) {
    kb.statistics = new kb.Statistics(); // turn on stats
  ...
  return it('kb.observableFormatted', function(done) {
    kb.statistics = new kb.Statistics(); // turn on stats
