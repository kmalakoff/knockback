...
try {
  ...
  require(['underscore', 'backbone', 'knockout', module_name, 'knockback-statistics', 'knockback-triggering', 'mocha_test_runner'], function(_, Backbone, ko, kb, kbs, kbt, runner) {
    window._ = window.Backbone = window.ko = window.kb = null;
    return require(['../../../knockback/triggering/build/test'], function() {
      return runner.start();
    });
  });
} catch (_error) {}
