...
try {
  ...
  require(['underscore', 'backbone', 'knockout', module_name, 'knockback-statistics', 'knockback-validation', 'mocha_test_runner'], function(_, Backbone, ko, kb, kbs, kbv, runner) {
    window._ = window.Backbone = window.ko = window.kb = null;
    return require(['../../../knockback/validation/build/test'], function() {
      return runner.start();
    });
  });
} catch (_error) {}
