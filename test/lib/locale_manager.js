...
/***/ function(module, exports, __webpack_require__) {
	...
	kb = typeof window !== "undefined" && window !== null ? window.kb : void 0;

	try {
	  kb || (kb = true ? __webpack_require__(2) : void 0);
	} catch (_error) {}
	...
	module.exports = kb.LocaleManager = (function() {
	  ...
	  LocaleManager.prototype.setLocale = function(locale_identifier) {
	    ...
	    _ref = this.translations_by_locale[this.locale_identifier] || {};
	    for (key in _ref) {
	      value = _ref[key];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = kb.LocalizedString = (function() {
