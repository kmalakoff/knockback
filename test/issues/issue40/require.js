...
(function (global) {
  ...
  function newContext(contextName) {
    ...
    function makeRequire(mod, enableBuildCallback, altRequire) {
      ...
      var modRequire = makeContextModuleFunc(altRequire || context.require, relMap, enableBuildCallback);
    ...
    Module.prototype = {
      ...
      callPlugin: function () {
        var map = this.map;
        var id = map.id;
        var pluginMap = makeModuleMap(map.prefix, null, false, true);
        ...
        on(
          ...
          bind(this, function (plugin) {
            ...
            plugin.load(
              map.name,
              makeRequire(map.parentMap, true, function (deps, cb, er) {
    ...
    return (context = {
       ...
       */
      enable: function (depMap, _parent) {
      ...
      completeLoad: function (moduleName) {
        ...
        var shExports = shim.exports && shim.exports.exports;
       ...
       * @private
       */
      execCb: function (_name, callback, args, exports) {
    ...
    if (!deps.length && isFunction(callback)) {
      ...
      if (callback.length) {
        callback
          ...
          .replace(cjsRequireRegExp, function (_match, dep) {
            deps.push(dep);
          });
