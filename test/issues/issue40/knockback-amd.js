...
(function (window, document, _navigator, undefined) {
  !(function (factory) {
    ...
    var Backbone;
    var KB_TYPE_ARRAY;
    var KB_TYPE_COLLECTION;
    var KB_TYPE_MODEL;
    var KB_TYPE_SIMPLE;
    var KB_TYPE_UNKNOWN;
    var Knockback;
    var addStatisticsEvent;
    var arraySlice;
    var arraySplice;
    var collapseOptions;
    var kb;
  ...
  */
    ...
    _unwrapModels = function (obj) {
      ...
      if (_.isObject(obj) && !ko.isObservable(obj) && !_.isDate(obj) && !_.isString(obj)) {
        result = {};
        for (key in obj) {
          value = obj[key];
    ...
    kb.utils = (function () {
      ...
      utils.wrappedObservable = function (_obj, _value) {
        return _wrappedKey.apply(this, _argumentsAddKey(arguments, 'observable'));
      };

      utils.wrappedObject = function (_obj, _value) {
  ...
  */
    ...
    kb.ModelWatcher = (function () {
      ...
      ModelWatcher.prototype._modelUnbindRelatationalInfo = function (_event_name, info) {
        if (!info.rel_fn) {
          return;
        }
  ...
  */
    ...
    kb.Observable = (function () {
      function Observable(model, options, vm) {
        ...
        create_options.key = undefined;
        this.key || throwMissing(this, 'key');
        !create_options.args || ((this.args = create_options.args), (create_options.args = undefined));
        !create_options.read || ((this.read = create_options.read), (create_options.read = undefined));
        !create_options.write || ((this.write = create_options.write), (create_options.write = undefined));
        model_watcher = create_options.model_watcher;
        create_options.model_watcher = undefined;
        ...
        if (kb.LocalizedObservable && create_options.localizer) {
          ...
          create_options.localizer = undefined;
        }
        if (kb.DefaultObservable && create_options.hasOwnProperty('default')) {
          ...
          create_options.default = undefined;
        }
        return observable;
      }
      ...
      Observable.prototype.update = function (new_value) {
        ...
        if (this.value_type === KB_TYPE_MODEL) {
  ...
  */
    ...
    kb.parseFormattedString = function (string, format) {
      ...
      sorted_positions = _.sortBy(_.keys(positions), function (parameter_index, _format_index) {
    ...
    kb.formattedObservable = function (format, _args) {
