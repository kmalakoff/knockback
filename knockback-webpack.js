...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  if ((typeof window !== "undefined" && window !== null) && __webpack_require__(1).shim) {
	  ...
	  module.exports = kb = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./kb\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	  if (this.Parse) {
	    Backbone = kb.Parse = this.Parse;
	  } else {
	    Backbone = kb.Backbone = __webpack_require__(3);
	  }
	  ...
	  for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
	    component = _ref2[_k];
	    kb.modules[component] = __webpack_require__(1)(component);
	  }
