...
`cd #{PROJECT_ROOT}; coffee -b -o test/knockback_packaging/build -c test/knockback_packaging`
...
`cd #{PROJECT_ROOT}; coffee -b -o test/knockback_formatted_observable/build -c test/knockback_formatted_observable`
